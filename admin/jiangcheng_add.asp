...
<script language="javascript">
	function checkform(form)
	{
		...
		else if (document.form.record.value=="")
		{
			alert("请输入通知内容！");
		}
	    else
                    ...
                    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td height="54" background="adminimages/titlebk1.gif"><div align="center">
                            <table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="50%"><div align="center"><a href="notice_viewed.asp">奖 惩 信 息 管 理</a></div></td>
                                </tr>
                            </table>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="86" background="adminimages/titlebk2.gif"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td height="45"><div align="center">添加奖惩信息</div></td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
                        <td background="../user/userimages/titlebk.gif"><div align="center">
                            <form name="form" method="post" action="jiangcheng_add1.asp" >
                              <div align="center">
                                <table width="90%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                  <tr>
                                    <td height="24"><div align="right" class="style10">学 号：&nbsp;&nbsp;</div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <input name="user_number" type="text" id="user_number" size="50"></td>
                                  </tr>
                                  <tr>
                                    <td ><div align="right" class="style10">奖惩内容：&nbsp;&nbsp;</div></td>
                                    <td height="25" class="style10">&nbsp;&nbsp;&nbsp;
                                      <input name="record" type="text" id="record" size="50"></td>
                                  </tr>
                                  <tr>
