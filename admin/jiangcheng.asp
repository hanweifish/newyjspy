                    ...
                    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td height="54" background="adminimages/titlebk1.gif"><div align="center">
                            <table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="50%"><div align="center"><a href="notice_viewed.asp"></a>奖惩信息管理</div></td>
                                </tr>
                            </table>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="86" background="adminimages/titlebk2.gif"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td height="45"><div align="center">奖惩信息列表 </div></td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
                              ...
                              <tr>
                                <td colspan="6">
                                    <table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                      <tr>
                                        <td width="50" height="24"><div align="center" class="style10">学 号</div></td>
                                        <td width="321" height="24"><div align="center" class="style10">奖 惩</div></td>
...
%>
                                      <tr>
                                        <td width="200" height="24"><div align="left" class="style10">&nbsp;&nbsp;<%=rs("user_number")%></div></td>
                                        <td height="24"><div align="left" class="style10">&nbsp;&nbsp;<%=rs("record")%></div></td>
                                        <td width="50" height="24"><div align="center"><a href=jiangcheng_mod.asp?jiangcheng_ID=<%=rs("jiangcheng_ID")%>><font color="#ff6633">修改</font></a></div></td>
                                        <td width="50" height="24"><div align="center"><a href=jiangcheng_del.asp?jiangcheng_ID=<%=rs("jiangcheng_ID")%>><font color="#ff6633">删除</font></a></div></td>
                                      </tr>
<%rs.movenext
...
%>
                                      <tr>
                                        <td height="24" colspan="8"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td><div align="center"><a href="jiangcheng_add.asp" class="style3">添加奖惩信息</a></div></td>
                                          </tr>
                                        </table></td>
                                      </tr>
                                  </table></td>
