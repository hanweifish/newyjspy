...
sql="select * from job where user_ID = "&rs("user_ID")&" order by job_time desc"
...
%>
                                      <tr>
                                        <td width="101" height="24"><div align="left" class="style10">&nbsp;&nbsp;<%=rst("job_time")%></div></td>
                                        <td height="24"><div align="left" class="style10">&nbsp;&nbsp;<%=rst("job_title")%></div></td>
                                        <td width="44" height="24"><div align="center"><a href=job_mod.asp?job_ID=<%=rst("job_ID")%>><font color="#ff6633">修改</font></a></div></td>
                                        <td width="45" height="24"><div align="center"><a href=job_del.asp?job_ID=<%=rst("job_ID")%>><font color="#ff6633">删除</font></a></div></td>
                                      </tr>
                                      <%rst.movenext
...
%>
                                      <tr>
                                        <td height="24" colspan="8"><div align="right" class="style2"> <span class="style10">
                                            ...
                                            <%
if NoncePage>1 then
	response.write "|<a href=job_set.asp?page=1>首 页</a>| |<a href=job_set.asp?page="&NoncePage-1&">上一页</a>|&nbsp"
else
	response.write "|首 页| |上一页|&nbsp"
end if
if Cint(Trim(NoncePage))<Cint(Trim(NumPage)) then
	response.write "|<a href=job_set.asp?page="&NoncePage+1&">下一页</a>| |<a href=job_set.asp?page="&NumPage&">尾 页</a>|"
else
