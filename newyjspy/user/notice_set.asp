...
%>
                                      <tr>
                                        ...
                                        <td width="44" height="24"><div align="center"><a href=notice_mod.asp?notice_ID=<%=rst("notice_ID")%>><font color="#ff6633">修改</font></a></div></td>
                                        <td width="45" height="24"><div align="center"><a href=notice_del.asp?notice_ID=<%=rst("notice_ID")%>><font color="#ff6633">删除</font></a></div></td>
                                      </tr>
                                      <%rst.movenext
