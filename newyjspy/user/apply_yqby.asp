...
<script language="javascript">
	function checkuser()
	{
		...
		if(document.form.yqbysq.value.length == "")
			{
				msg = msg + "   请输入申请时间!\n\n";
			}
		if(document.form.yqby1.value.length == "")
			{
				msg = msg + "   请输入延期至何时毕业!\n\n";
			}
                      ...
                      <form name="form" method="post" action="apply_yqby1.asp">
                        <div align="center">
                          <table width="90%" height="100%" border="0" cellpadding="0" cellspacing="0" class="thin">
                            ...
                            <tr>
                              <td height="24"><div align="right" class="style10">延期至何时毕业：&nbsp;&nbsp;</div></td>
                              <td colspan="2" class="style10"><input type="text" name="yqby1">
                                <span class="STYLE14">(格式：2007年02月)</span></td>
                            </tr>
                            <tr>
                              <td height="24"><div align="right" class="style10">申请时间：&nbsp;&nbsp;</div></td>
                              <td colspan="2" class="style10"><input type="text" name="yqbysq">
