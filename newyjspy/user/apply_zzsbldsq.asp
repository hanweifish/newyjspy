...
<script language="javascript">
	function checkuser()
	{
		...
		if(document.form.zzsbldsq.value.length == "")
			{
				msg = msg + "    请输入申请时间!\n\n";
			}
		if(document.form.zzsbld1.value.length == "")
			{
				msg = msg + "    请输入硕士学号!\n\n";
			}	
		if(document.form.zzsbld2.value.length == "")
			{
				msg = msg + "    请输入硕士专业!\n\n";
			}
		if(document.form.zzsbld3.value.length == "")
			{
				msg = msg + "    请输入导师姓名!\n\n";
			}								
		if(msg !="") 
              ...
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td background="userimages/titlebk.gif"><div align="center">
                      <form name="form" method="post" action="apply_zzsbldsq1.asp">
                        <div align="center">
                          <table width="90%" height="100%" border="0" cellpadding="0" cellspacing="0" class="thin">
                            ...
                            <tr>
                              <td height="24"><div align="right" class="style10">硕士学号：&nbsp;&nbsp;</div></td>
                              <td colspan="2" class="style10"><input type="text" name="zzsbld1">                                </td>
                            </tr>
                            <tr>
                              <td height="24"><div align="right" class="style10">硕士专业：&nbsp;&nbsp;</div></td>
                              <td colspan="2" class="style10"><input type="text" name="zzsbld2">                              </td>
                            </tr>
                            <tr>
                              <td height="24"><div align="right" class="style10">导师姓名：&nbsp;&nbsp;</div></td>
                              <td colspan="2" class="style10"><input type="text" name="zzsbld3">
                              </td>
                            </tr>
                            <tr>
                              <td height="24"><div align="right" class="style10">终止硕博连读原因：&nbsp;&nbsp;</div></td>
                              <td colspan="2" class="style10"><select name="zzsbld4">
							  <option value="学业困难" selected="selected">学业困难</option>
							  <option value="参加工作">参加工作</option>
							  <option value="出国留学">出国留学</option>
							  <option value="健康原因">健康原因</option>
                            ...
                            <tr>
                              ...
                              <td colspan="2" class="style10"><input type="text" name="zzsbldsq">
