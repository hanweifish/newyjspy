...
sql="select user_info.user_number,user_info.user_name,user_info.user_major,user_info.user_pyxz,user_info.user_csrq,user_info.user_tutor,apply.user_number,apply.apply_email from apply inner join user_info on user_info.user_number=apply.user_number where apply.user_number='"&user_account&"'"
...
<script language="javascript">
	...
	{
		var msg = "";
		if(document.form.apartdate.value == ""||document.form.apartdate.value == "待添加")
			{
				msg = msg + "      请输入拟定出国日期!\n\n";
			}			
              ...
              <td height="100"><div align="center">
                <table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0" background="../indeximages/loginbk.gif">
                  <tr>
                    ...
                    <td width="60%" class="style3"><%=rs("user_number")%>：</td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
              ...
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td background="userimages/titlebk.gif"><div align="center">
                      <form name="form" method="post" action="apply_date1.asp">
                        <div align="center">
                          <table width="90%" height="100%" border="0" cellpadding="0" cellspacing="0" class="thin">
                            ...
                            <tr>
                              ...
                              <td colspan="2" class="style10"><input type="text" name="apartdate">
                                <span class="STYLE14">(格式：2007.11.20)</span></td>
                            </tr>
				  ...
				  <table>
				  <tr>
                              <td width="18%"><div align="center" class="style10"> 您不在申报出国名单里,请与研究生院联系确认!</div></td>
							  </tr></table>
				  <%
				  end if
				  %>
