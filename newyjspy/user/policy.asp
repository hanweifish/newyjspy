                ...
                <table width="603"  border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td colspan="3"><div align="center">
                        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="54" background="userimages/titlebk1.gif"><div align="center"><img src="userimages/policy.gif"></div></td>
                          </tr>
                          <tr>
...
%>
                                        <table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                          <tr align="center">
                                            ...
                                            <td width="76%" height="24"><div align="center" class="style10">政&nbsp;&nbsp;&nbsp;策&nbsp;&nbsp;&nbsp;标 &nbsp;&nbsp;&nbsp;题 </div></td>
                                          </tr>
...
%>
                                          <tr>
                                            <td width="150" height="25" align="center" valign="middle"><div align="left" class="style10">
                                                <div align="center"><%=rsn("policy_time")%></div>
                                            </div></td>
                                            <td height="25"><div align="left"></div>
                                                <div align="left">&nbsp;&nbsp;&nbsp;&nbsp;<a href=policy_detail.asp?policy_ID=<%=rsn("policy_ID")%> class="style3"><%=rsn("policy_title")%></a></div></td>
                                          </tr>
                                          <%rsn.movenext
...
%>
                                          <tr>
                                            <td height="24" colspan="8" align="center" valign="middle"><div align="right"><span class="style2">
                                                ...
                                                <%
if NoncePage>1 then
	response.write "|<a href=policy.asp?page=1>首 页</a>| |<a href=policy.asp?page="&NoncePage-1&">上一页</a>|&nbsp"
else
	response.write "|首 页| |上一页|&nbsp"
end if
if Cint(Trim(NoncePage))<Cint(Trim(NumPage)) then
	response.write "|<a href=policy.asp?page="&NoncePage+1&">下一页</a>| |<a href=policy.asp?page="&NumPage&">尾 页</a>|"
else
