...
<script language="javascript">
	...
	{
		if (document.form.tongzhi_title.value=="")
		{
			alert("请输入通知标题！");
		}
		else if (document.form.tongzhi_content.value=="")
		{
			alert("请输入通知内容！");
		}
		else if (document.form.tongzhi_time.value=="")
		{
			alert("请输入通知发布时间！");
		}
	    else
              ...
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td background="userimages/titlebk.gif"><div align="center">
                      <form name="form" method="post" action="tongzhi_add1.asp" >
                        <div align="center">
                          <table width="90%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                            <tr>
                              <td height="24"><div align="right" class="style10">通知标题：&nbsp;&nbsp;</div></td>
                              <td class="style10">&nbsp;&nbsp;&nbsp;
                                  <input name="tongzhi_title" type="text" id="tongzhi_title" size="50"></td>
                            </tr>
                            <tr>
                              <td ><div align="right" class="style10">通知内容：&nbsp;&nbsp;</div></td>
                              <td class="style10">&nbsp;&nbsp;&nbsp;
                                  <textarea name="tongzhi_content" cols="50" rows="15" id="tongzhi_content"></textarea></td>
                            </tr>
                            <tr>
                              <td height="24"><div align="right" class="style10">通知备注：&nbsp;&nbsp;</div></td>
                              <td class="style10">&nbsp;&nbsp;&nbsp;
                                  <textarea name="tongzhi_info" cols="50" rows="10" id="tongzhi_info">无</textarea>
                              </td>
                            </tr>
                            <tr>
                              <td height="24"><div align="right" class="style10">发布时间：&nbsp;&nbsp;</div></td>
                              <td class="style10">&nbsp;&nbsp;&nbsp;
                                  <input name="tongzhi_time" type="text" id="tongzhi_time" size="25"> 
                                  &nbsp;&nbsp;&nbsp;&nbsp;（格式：2005-05-06）</td>
                            </tr>
                            <tr>
