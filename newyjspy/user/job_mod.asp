              ...
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td background="userimages/titlebk.gif"><div align="center">
                      <form name="form" method="post" action="job_mod1.asp">
                        <div align="center">
                          <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                            <tr>
                              ...
                              <td class="style10">&nbsp;&nbsp;&nbsp;
                                  <input name="job_title" type="text" id="job_title" value="<%=rst("job_title")%>"></td>
                            </tr>
                            <tr>
                              ...
                              <td class="style10">&nbsp;&nbsp;&nbsp;
                                  <textarea name="job_content" cols="50" rows="15" id="job_content" ><%=rst("job_content")%></textarea></td>
                            </tr>
                            <tr>
                              <td width="100" ><div align="right" class="style10">
                              ...
                              <td class="style10">&nbsp;&nbsp;&nbsp;
                                  <textarea name="job_info" cols="50" rows="10" id="job_info"><%=rst("job_info")%></textarea>
                              </td>
                            </tr>
                            <tr>
