...
<script language="javascript">
	function checkuser()
	{
		...
		if(document.form.zzysq.value.length == "")
			{
				msg = msg + "   请输入申请时间!\n\n";
			}
		if(document.form.zzy1.value.length == "")
			{
				msg = msg + "   请输入拟转专业!\n\n";
			}	
		if(document.form.zzy2.value.length == "")
			{
				msg = msg + "   请输入拟转院系!\n\n";
			}
		if(document.form.zzy3.value.length == "")
			{
				msg = msg + "   请输入导师姓名!\n\n";
			}					
		if(msg !="") 
              ...
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td background="userimages/titlebk.gif"><div align="center">
                      <form name="form" method="post" action="apply_zzy1.asp">
                        <div align="center">
                          <table width="90%" height="100%" border="0" cellpadding="0" cellspacing="0" class="thin">
                            ...
                            <tr>
                              <td height="24"><div align="right" class="style10">拟转专业：&nbsp;&nbsp;</div></td>
                              <td colspan="2" class="style10"><input type="text" name="zzy1">                                </td>
                            </tr>
                            <tr>
                              <td height="24"><div align="right" class="style10">拟转院系：&nbsp;&nbsp;</div></td>
                              <td colspan="2" class="style10"><input type="text" name="zzy2">                              </td>
                            </tr>
                            <tr>
                              <td height="24"><div align="right" class="style10">导师姓名：&nbsp;&nbsp;</div></td>
                              <td colspan="2" class="style10"><input type="text" name="zzy3">
                              </td>
                            </tr>
							<tr>
                              <td height="24"><div align="right" class="style10">转专业原因：&nbsp;&nbsp;</div></td>
                              <td colspan="2" class="style10"><select name="zzy4">
							  <option value="专业调整" selected="selected">专业调整</option>
							  <option value="导师变动">导师变动</option>
							  <option value="个人兴趣">个人兴趣</option>
							  <option value="就业原因">就业原因</option>						  
							  <option value="其它">其它</option>
							  </select>                              </td>
                            </tr>
                            <tr>
                              <td height="24"><div align="right" class="style10">申请时间：&nbsp;&nbsp;</div></td>
                              <td colspan="2" class="style10"><input type="text" name="zzysq">
