...
<script language="javascript">
	function checkuser()
	{
		...
		if(document.form.fxsq.value.length == "")
			{
				msg = msg + "   请输入申请时间!\n\n";
			}
		if(document.form.fx1.value.length == "")
			{
				msg = msg + "   请输入休学期间!\n\n";
			}					
		if(msg !="") 
              ...
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td background="userimages/titlebk.gif"><div align="center">
                      <form name="form" method="post" action="apply_fx1.asp">
                        <div align="center">
                          <table width="90%" height="100%" border="0" cellpadding="0" cellspacing="0" class="thin">
                            ...
                            <tr>
                              <td height="24"><div align="right" class="style10">休学期间：&nbsp;&nbsp;</div></td>
                              <td colspan="2" class="style10"><input type="text" name="fx1">
                                <br>
                                <span class="STYLE14">(格式：2007年02月至2008年02月)</span></td>
                            </tr>
                            <tr>
                              <td height="24"><div align="right" class="style10">申请时间：&nbsp;&nbsp;</div></td>
                              <td colspan="2" class="style10"><input type="text" name="fxsq">
                                  <span class="STYLE14">(格式：2007.02.20)</span></td>
                            </tr>
                            <tr>
                              <td height="24"><div align="right" class="style10">复学审查是否通过：&nbsp;&nbsp;</div></td>
