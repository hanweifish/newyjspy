...
sql="select * from policy_viewed where user_account='"&session("user_account")&"' and policy_ID="&policy_ID 
                ...
                <table width="603"  border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td colspan="3"><div align="center">
                        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="54" background="userimages/titlebk1.gif"><div align="center"><img src="userimages/policy.gif" width="523" height="45"></div></td>
                          </tr>
                          <tr>
                                ...
                                <table width="80%"  border="0" cellpadding="0" cellspacing="0" class="thin">
                                  <tr>
                                    <td><table width="100%"  border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                          <td height="25" bgcolor="#CFDBEF"><div align="center" class="style3"><%=rsn("policy_title")%></div></td>
                                        </tr>
                                        <tr>
                                          <td><div align="center">
                                              <table width="80%"  border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                  <td width="39%" height="20" class="style2">发布人：<%=rsn("policy_author")%></td>
                                                  <td width="17%" class="style15"><div align="right"></div></td>
                                                  <td width="44%" class="style15"><div align="right" class="style2">发布时间：<%=rsn("policy_time")%>&nbsp;&nbsp;</div></td>
                                                </tr>
                                                <tr>
