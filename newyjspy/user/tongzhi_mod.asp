              ...
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td background="userimages/titlebk.gif"><div align="center">
                      <form name="form" method="post" action="tongzhi_mod1.asp">
                        <div align="center">
                          <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                            <tr>
                              ...
                              <td class="style10">&nbsp;&nbsp;&nbsp;
                                  <input type="text" name="tongzhi_title" value="<%=rst("tongzhi_title")%>"></td>
                            </tr>
                            <tr>
                              ...
                              <td class="style10">&nbsp;&nbsp;&nbsp;
                                  <textarea name="tongzhi_content" cols="50" rows="15" ><%=rst("tongzhi_content")%></textarea></td>
                            </tr>
                            <tr>
                              <td width="100" ><div align="right" class="style10">
                              ...
                              <td class="style10">&nbsp;&nbsp;&nbsp;
                                  <textarea name="tongzhi_info" cols="50" rows="10"><%=rst("tongzhi_info")%></textarea>
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td class="style10">&nbsp;&nbsp;&nbsp;
                                  <input name="tongzhi_time" type="text" id="tongzhi_time" value="<%=rst("tongzhi_time")%>">
&nbsp;&nbsp;&nbsp;&nbsp;（格式：2005-05-06）</td>
                            </tr>
                            <tr>
                              <td height="35" colspan="2"><div align="center"><img src="userimages/editSub.gif" width="70" height="25" align="absmiddle" style="cursor:hand; " onMouseDown="javascript:submit();"> </div></td>
                            </tr>
                          </table>
                        </div>
                      </form>
