              ...
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="54" background="../admin/adminimages/titlebk1.gif"><div align="center">
                      <table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td><div align="center"><a href="notice_add.asp"><img src="../admin/adminimages/noticeadd.gif" width="170" height="24" border="0"></a></div>                            <div align="center"></div>                            <div align="center"></div></td>
                          </tr>
                      </table>
                    </div></td>
                  </tr>
                  ...
                  <tr>
                    <td background="userimages/titlebk.gif"><div align="center">
                      <form name="form" method="post" action="notice_mod1.asp">
                        <div align="center">
                          <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                            <tr>
                              ...
                              <td class="style10">&nbsp;&nbsp;&nbsp;
                                  <input type="text" name="notice_title" value="<%=rst("notice_title")%>"></td>
                            </tr>
                            <tr>
                              ...
                              <td class="style10">&nbsp;&nbsp;&nbsp;
                                  <textarea name="notice_content" cols="50" rows="15" ><%=rst("notice_content")%></textarea></td>
                            </tr>
                            <tr>
                              <td width="100" ><div align="right" class="style10">
                              ...
                              <td class="style10">&nbsp;&nbsp;&nbsp;
                                  <textarea name="notice_info" cols="50" rows="10"><%=rst("notice_info")%></textarea>
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td class="style10">&nbsp;&nbsp;&nbsp;
                                  <input name="notice_time" type="text" id="notice_time" value="<%=rst("notice_time")%>">
&nbsp;&nbsp;&nbsp;&nbsp;（格式：2005-05-06）</td>
                            </tr>
                            <tr>
