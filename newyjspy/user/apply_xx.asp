...
<script language="javascript">
	function checkuser()
	{
		...
		if(document.form.xxsq.value.length == "")
			{
				msg = msg + "   请输入申请时间!\n\n";
			}		
		if(msg !="") 
              ...
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td background="userimages/titlebk.gif"><div align="center">
                      <form name="form" method="post" action="apply_xx1.asp">
                        <div align="center">
                          <table width="90%" height="100%" border="0" cellpadding="0" cellspacing="0" class="thin">
                            ...
                            <tr>
                              <td height="24"><div align="right" class="style10">休学原因：&nbsp;&nbsp;</div></td>
                              <td colspan="2" class="style10"><select name="xx1">
							  <option value="健康原因" selected="selected">健康原因</option>
                            ...
                            <tr>
                              ...
                              <td colspan="2" class="style10"><input type="text" name="xxsq">
