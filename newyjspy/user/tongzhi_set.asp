...
sql="select * from tongzhi where tongzhi_author = '"&rs("user_account")&"' order by tongzhi_time desc"
              ...
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="54" background="../admin/adminimages/titlebk1.gif"><div align="center">
                      <table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td><div align="center"><a href="tongzhi_add.asp"><img src="../admin/adminimages/noticeadd.gif" width="170" height="24" border="0"></a></div>                            <div align="center"></div>                            <div align="center"></div></td>
                          </tr>
                      </table>
                    </div></td>
                  </tr>
...
%>
                              <table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                <tr>
                                  <td width="101" height="24"><div align="center" class="style10">发表日期</div></td>
                                  <td width="343" height="24"><div align="center" class="style10">通知标题</div></td>
                                  <td width="44" height="24"><div align="center" class="style10">修改</div></td>
                                  <td width="45" height="24"><div align="center" class="style10">删除</div></td>
                                </tr>
...
%>
                                <tr>
                                  <td width="101" height="24"><div align="left" class="style10">&nbsp;&nbsp;<%=rst("tongzhi_time")%></div></td>
                                  <td height="24"><div align="left" class="style10">&nbsp;&nbsp;<%=rst("tongzhi_title")%></div></td>
                                  <td width="44" height="24"><div align="center"><a href=tongzhi_mod.asp?tongzhi_ID=<%=rst("tongzhi_ID")%>><font color="#ff6633">修改</font></a></div></td>
                                  <td width="45" height="24"><div align="center"><a href=tongzhi_del.asp?tongzhi_ID=<%=rst("tongzhi_ID")%>><font color="#ff6633">删除</font></a></div></td>
                                </tr>
                                <%rst.movenext
...
%>
                                <tr>
                                  <td height="24" colspan="8"><div align="right" class="style2"> <span class="style10">
                                      ...
                                      <%
if NoncePage>1 then
	response.write "|<a href=tongzhi_set.asp?page=1>首 页</a>| |<a href=tongzhi_set.asp?page="&NoncePage-1&">上一页</a>|&nbsp"
else
	response.write "|首 页| |上一页|&nbsp"
end if
if Cint(Trim(NoncePage))<Cint(Trim(NumPage)) then
	response.write "|<a href=tongzhi_set.asp?page="&NoncePage+1&">下一页</a>| |<a href=tongzhi_set.asp?page="&NumPage&">尾 页</a>|"
else
	response.write "|下一页| |尾 页|"
end if
%>
                                  </span> &nbsp;页次：<span class="style3"><font color="#0033CC"><%=NoncePage%></font></span><span class="style10">/<font color="#0033CC"><%=NumPage%></font> </span>共<span class="style3"><font color="#0033CC"><%=NumRecord%></font></span>条记录&nbsp; </div></td>
                                </tr>
                            </table></td>
                        </tr>
                      </table>
