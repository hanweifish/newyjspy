...
<script language="javascript">
	function checkuser()
	{
		...
		if(document.form.zdssq.value.length == "")
			{
				msg = msg + "   请输入申请时间!\n\n";
			}
		if(document.form.zds1.value.length == "")
			{
				msg = msg + "   请输入拟转导师姓名!\n\n";
			}	
		if(document.form.zds3.value.length == "")
			{
				msg = msg + "   请输入原导师姓名!\n\n";
			}								
		if(msg !="") 
              ...
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td background="userimages/titlebk.gif"><div align="center">
                      <form name="form" method="post" action="apply_zds1.asp">
                        <div align="center">
                          <table width="90%" height="100%" border="0" cellpadding="0" cellspacing="0" class="thin">
                            ...
                            <tr>
                              <td height="24"><div align="right" class="style10">拟转导师姓名：&nbsp;&nbsp;</div></td>
                              <td colspan="2" class="style10"><input type="text" name="zds1">                                </td>
                            </tr>
                            <tr>
                              <td height="24"><div align="right" class="style10">转导师原因：&nbsp;&nbsp;</div></td>
                              <td colspan="2" class="style10"><select name="zds2">
                            ...
                            <tr>
                              ...
                              <td colspan="2" class="style10"><input type="text" name="zdssq">
                                  <span class="STYLE14">(格式：2007.02.20)</span></td>
                            </tr>
                            <tr>
                              <td height="24"><div align="right" class="style10">原导师姓名：&nbsp;&nbsp;</div></td>
                              <td colspan="2" class="style10"><input type="text" name="zds3">
                              </td>
                            </tr>
