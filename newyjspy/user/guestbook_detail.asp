                      ...
                      <tr>
                        <td background="userimages/titlebk.gif"><div align="center">
						  <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td height="25"><div align="center"><a href="guestbook_send.asp" class="style3">发 表 留 言</a>&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
                            </tr>
                            <tr>
                                ...
                                <tr>
                                  <td><div align="center">
                                      <table width="80%"  border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td width="39%" height="20" class="style10">回复人：<%=rsr("author")%></td>
...
&nbsp;</td>
                                        ...
                                        <tr>
                                          <td height="25" colspan="3"><div align="center"><a href="guestbook.asp">返 回</a></div></td>
                                        </tr>
                                      </table>
                                  </div></td>
                                </tr>
