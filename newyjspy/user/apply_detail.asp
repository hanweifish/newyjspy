...
%>                          
                            <tr>
                              <td height="24"><div align="right" class="style10">提前毕业时间：&nbsp;&nbsp;</div></td>
                              <td colspan="2" class="style10"><input type="text" name="tqbysj">
                                <span class="STYLE14">(格式：2007年02月)</span></td>
                            </tr>
                            <tr>
                              <td height="24"><div align="right" class="style10">申请时间：&nbsp;&nbsp;</div></td>
                              <td colspan="2" class="style10"><input type="text" name="sqsj">
...
%> 
<tr>
                              <td height="24"><div align="right" class="style10">延期毕业时间：&nbsp;&nbsp;</div></td>
                              <td colspan="2" class="style10"><input type="text" name="tqbysj">
                                <span class="STYLE14">(格式：2007年02月)</span></td>
                            </tr>
                            <tr>
...
%>							
                            <tr>
                              ...
                              <td colspan="2" class="style10"><input type="text" name="phone"></td>
                            </tr>
