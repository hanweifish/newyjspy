...
<script language="javascript">
	function checkuser()
	{
		...
		if(document.form.qxxjsq.value.length == "")
			{
				msg = msg + "   请输入申请时间!\n\n";
			}		
		if(msg !="") 
              ...
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td background="userimages/titlebk.gif"><div align="center">
                      <form name="form" method="post" action="apply_qxxj1.asp">
                        <div align="center">
                          <table width="90%" height="100%" border="0" cellpadding="0" cellspacing="0" class="thin">
                            ...
                            <tr>
                              <td height="24"><div align="right" class="style10">取消学籍原因：&nbsp;&nbsp;</div></td>
                              <td colspan="2" class="style10"><select name="qxxj1">
							  <option value="自动中止学业" selected="selected">自动中止学业</option>
							  <option value="未按规定缴费">未按规定缴费</option>
							  <option value="私自出国">私自出国</option>
							  <option value="其它">其它</option>
							  </select>                              </td>
                            </tr>
                            <tr>
                              <td height="24"><div align="right" class="style10">申请时间：&nbsp;&nbsp;</div></td>
                              <td colspan="2" class="style10"><input type="text" name="qxxjsq">
