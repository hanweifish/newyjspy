                    ...
                    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td height="86" background="../admin/adminimages/titlebk2.gif"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td height="45"><div align="center"><img src="../indeximages/user_notice.gif" width="523" height="45"></div></td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
                              ...
                              <div align="center">
                                <table width="90%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                  <tr>
                                    ...
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <input name="notice_title" type="text" id="notice_title" size="50"></td>
                                  </tr>
                                  <tr>
                                    <td ><div align="right" class="style10">通知内容：&nbsp;&nbsp;</div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <textarea name="notice_content" cols="50" rows="15" id="notice_content"></textarea></td>
                                  </tr>
                                  <tr>
                                    <td height="24"><div align="right" class="style10">通知备注：&nbsp;&nbsp;</div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <textarea name="notice_info" cols="50" rows="10" id="notice_info">无</textarea>
                                    </td>
                                  </tr>
                                  <tr>
