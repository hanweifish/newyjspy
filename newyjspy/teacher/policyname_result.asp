                              ...
                              <tr>
                                <td colspan="6"><table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                    <tr>
                                      ...
                                      <td height="24"><div align="center" class="style10">查看过的政策</div></td>
                                    ...
                                    <tr>
                                      <td height="24" colspan="8"><div align="right" class="style2"> <span class="style10">
                                          <input type="hidden" name="page" value="<%=NoncePage%>">
                                              ...
                                              <%
if NoncePage>1 then
	response.write "|<a href=policyname_result.asp?page=1&user_name="&user_name&">首 页</a>| |<a href=policyname_result.asp?page="&NoncePage-1&"&user_name="&user_name&">上一页</a>|&nbsp"
else
	response.write "|首 页| |上一页|&nbsp"
end if
if Cint(Trim(NoncePage))<Cint(Trim(NumPage)) then
	response.write "|<a href=policyname_result.asp?page="&NoncePage+1&"&user_name="&user_name&">下一页</a>| |<a href=policyname_result.asp?page="&NumPage&"&user_name="&user_name&">尾 页</a>|"
else
