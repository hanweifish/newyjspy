...
sql="select user_info.user_name,user_info.user_number,notice_viewed.viewed_date,notice_viewed.viewed_time,notice.notice_title from user_info inner join (notice_viewed inner join notice on notice_viewed.notice_ID=notice.notice_ID) on user_info.user_account = notice_viewed.user_account where user_info.user_name like '%"&user_name&"%' order by notice_viewed.viewed_date desc"
...
%>
                              <tr>
                                <td height="25" colspan="6"><div align="center" class="style8 style13"><span class="style3">“</span><span class="style16"><%=rs("user_name")%></span><span class="style3">”</span> 查看记录</div></td>
                              </tr>
                              <tr>
                                <td colspan="6"><table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                    <tr>
                                      ...
                                      <td height="24"><div align="center" class="style10">查看过的通知</div></td>
...
%>
                                    <tr>
                                      ...
                                      <td height="24"><div align="center" class="style10"><%=rs("notice_title")%></div></td>
                                    ...
                                    <tr>
                                      <td height="24" colspan="8"><div align="right" class="style2"> <span class="style10">
                                          <input type="hidden" name="page" value="<%=NoncePage%>">
                                              ...
                                              <%
if NoncePage>1 then
	response.write "|<a href=noticename_result.asp?page=1&user_name="&user_name&">首 页</a>| |<a href=noticename_result.asp?page="&NoncePage-1&"&user_name="&user_name&">上一页</a>|&nbsp"
else
	response.write "|首 页| |上一页|&nbsp"
end if
if Cint(Trim(NoncePage))<Cint(Trim(NumPage)) then
	response.write "|<a href=noticename_result.asp?page="&NoncePage+1&"&user_name="&user_name&">下一页</a>| |<a href=noticename_result.asp?page="&NumPage&"&user_name="&user_name&">尾 页</a>|"
else
	response.write "|下一页| |尾 页|"
end if
%>
&nbsp;页次：<span class="style10"><font color="#0033CC" class="style3"><%=NoncePage%></font></span>/<span class="style10"><font color="#0033CC"><%=NumPage%></font> </span>共<span class="style3"><font color="#0033CC"><%=NumRecord%></font></span>条记录&nbsp; </div></td>
                                    </tr>
                                </table></td>
                              </tr>
                              <%end if	
