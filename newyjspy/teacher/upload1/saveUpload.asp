...
dim formsize,formdata,Msg,tutor_id
...
Msg = ""
		...
		if ftitle<>"" and fileSize > 0 and UploadSize=True then
			...
			dim basepath,sql
			basepath = "./uploadfile/"
			sql = "insert into info1 (filetitle,filedesc,filetype,filecontenttype,filepath,filesize,tutor_id) values ('"
			sql = sql & ftitle &"','"&filedesc&"','"&ftype&"','"&file_ctype&"','"&basepath&filename&"','"&filesize&"','"&tutor_id&"')"
			myconn.Execute(sql)
...
<title>上传成功</title>
<meta http-equiv="refresh" content="10;URL=../../admin/upload1/Index.asp">
<link href="../../style.css" rel="stylesheet" type="text/css">
</head>

<body topmargin="0">
<!--#include file="../../admin/upload1/top1.asp"-->
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    <td height="150"> <table width="98%" border="0" cellspacing="0" cellpadding="3">
        <tr class="text"> 
          <td class="style2">提示信息：</td>
        </tr>
        <tr class="text"> 
          <td> <%=msg%> </td>
        </tr>
        <tr class="text"> 
          <td><div align="center">本页将在10秒后返回 如果您的浏览器没有反应，请<a href="../../admin/upload1/Index.asp">点击此处返回</a></div></td> 
        </tr>
      </table></td>
  </tr>
</table>
