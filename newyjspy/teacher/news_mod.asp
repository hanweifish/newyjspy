                    ...
                    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td height="86" background="adminimages/titlebk2.gif"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td height="45"><div align="center"><img src="adminimages/newsset.gif" width="523" height="45"></div></td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
                              ...
                              <div align="center">
                                <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                  <tr>
                                    ...
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <input type="text" name="news_title" value="<%=rs("news_title")%>"></td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    <td width="100" ><div align="right" class="style10">
                                        <div align="center">新闻备注：</div>
                                    </div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <textarea name="news_info" cols="50" rows="10"><%=rs("news_info")%></textarea>
                                    </td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <input type="text" name="news_author" value="<%=rs("news_author")%>"></td>
                                  </tr>
                                  <tr>
