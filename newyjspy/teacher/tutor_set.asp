                              ...
                              <tr>
                                <th scope="col"><div align="center">
                                    <table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                      <tr>
                                        <td width="19%" height="25"><div align="center" class="style2">姓 名</div></td>
                                        <td width="19%"><div align="center" class="style2">职 称</div></td>
                                        <td width="36%"><div align="center" class="style2">照片</div></td>
                                        <td width="12%"><div align="center" class="style2">修 改</div></td>
                                        <td width="14%"><div align="center" class="style2">删 除</div></td>
                                      </tr>
...
%>
								...
								%>
                                            ...
                                            <%else%>
                                            <a href="upload1/index.asp?tutor_id=<%=tutor_id%>">添加照片</a>
                                            <%end if%>
                                            <%rspic.close%>
                                            <%set rspic=nothing%>
                                        </div></td>
                                        <td><div align="center" ><a href=tutor_mod.asp?tutor_ID=<%=rs("tutor_ID")%> class="style3">修 改</a></div></td>
                                        <td><div align="center" class="style3"><a href=tutor_del.asp?tutor_ID=<%=rs("tutor_ID")%> class="style3">删 除</a></div></td>
                                      </tr>
                                      <%rs.movenext
...
%>
                                      <tr valign="middle">
                                        <td height="24" colspan="9"><div align="right"> <span class="style2">
                                            ...
                                            <%
if NoncePage>1 then
	response.write "|<a href=tutor_set.asp?page=1>首 页</a>| |<a href=tutor_set.asp?page="&NoncePage-1&">上一页</a>|&nbsp"
else
	response.write "|首 页| |上一页|&nbsp"
end if
if Cint(Trim(NoncePage))<Cint(Trim(NumPage)) then
	response.write "|<a href=tutor_set.asp?page="&NoncePage+1&">下一页</a>| |<a href=tutor_set.asp?page="&NumPage&">尾 页</a>|"
else
