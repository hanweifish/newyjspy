...
<script language="javascript">
	function checkform(form)
	{
		...
		else if (document.form.period.value=="")
		{
			alert("请输入周学时！");
		}		
                    ...
                    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td background="../user/userimages/titlebk.gif"><div align="center">
                            <form name="form" method="post" action="subject_add1.asp">
                              <div align="center">
                                <table width="90%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                  <tr>
                                    ...
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <input name="course" type="text" class="style3"></td>
                                  </tr>
                                  <tr>
                                    <td height="24"><div align="right" class="style10">课程编号：&nbsp;&nbsp;</div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <input name="coursenumber" type="text" class="style3"></td>
                                  </tr>
								  <tr>
                                    <td height="24"><div align="right" class="style10">授课老师：&nbsp;&nbsp;</div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <input name="tutor" type="text" class="style3"></td>
                                  </tr>
                                  <tr>
                                    <td height="24"><div align="right" class="style10">学分数：&nbsp;&nbsp;</div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <input name="credit" type="text" class="style3" ></td>
                                  </tr>
								  <tr>
                                    <td height="24"><div align="right" class="style10">周学时：&nbsp;&nbsp;</div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <input name="period" type="text" class="style3" ></td>
                                  </tr>
								  <tr>
                                    <td height="24"><div align="right" class="style10">上课人数：&nbsp;&nbsp;</div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <input name="people" type="text" class="style3" ></td>
                                  </tr>
                                  <tr>
                                    <td height="24"><div align="right"><span class="style10">学期：&nbsp;&nbsp;</span></div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                      <label>
                                  ...
                                  <tr>
                                    ...
                                    <td class="style10"><div align="left">&nbsp;&nbsp;&nbsp;
                                        <input name="teachway" type="text" class="style3" id="teachway" ><input name="admin_yx" type="hidden" value="<%=admin_yx%>"><input name="admin_academy" type="hidden" value="<%=admin_academy%>">
                                    </div></td>
                                  </tr>
                                  <tr>
