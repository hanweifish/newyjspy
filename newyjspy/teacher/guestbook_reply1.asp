              ...
              <tr>
                <td colspan="3"><div align="center">
                    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td height="86" background="adminimages/titlebk2.gif"><div align="center" class="style2">回 复 留 言</div></td>
                      </tr>
                      <tr>
                        <td background="../user/userimages/titlebk.gif"><div align="center">
                            <table width="90%"  border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td><form name="form" method="post" action="guestbook_reply2.asp" >
                                    <div align="center">
                                      <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                        <tr>
                                          <td height="24"><div align="right" class="style10">回复标题：&nbsp;&nbsp;</div></td>
                                          <td class="style10">&nbsp;&nbsp;&nbsp;
                                              <input name="title" type="text" class="style3" id="title" value="Re: <% = title%>" size="50"></td>
                                        </tr>
                                        <tr>
                                          <td ><div align="right" class="style10">回复正文：&nbsp;&nbsp;</div></td>
                                          <td class="style10">&nbsp;&nbsp;&nbsp;
                                              <textarea name="content" cols="50" rows="15" class="style3" id="content"></textarea></td>
                                        </tr>
                                        <tr>
                                          <td height="24"><div align="right"><span class="style10">回复人：&nbsp;&nbsp;</span></div></td>
                                          <td class="style10">&nbsp;&nbsp;&nbsp;
                                              <input name="author" type="text" class="style3" id="author" size="50" value="<% = admin_account%>">
											  <input name="user_ID" type="hidden"  id="user_ID" value="<% = user_ID%>"></td>
                                        </tr>
                                        <tr>
