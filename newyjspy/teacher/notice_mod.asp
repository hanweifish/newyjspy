                    ...
                    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td background="../user/userimages/titlebk.gif"><div align="center">
                            <form name="form" method="post" action="notice_mod1.asp?page=<%=page%>">
                              <div align="center">
                                <table width="90%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                  <tr>
                                    <td width="100" height="24"><div align="right" class="style10">
                                        <div align="center">通知标题：</div>
                                    </div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <input type="text" name="notice_title" value="<%=rs("notice_title")%>"></td>
                                  </tr>
                                  <tr>
                                    <td width="100" ><div align="right" class="style10">
                                        <div align="center">通知内容：</div>
                                    </div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <textarea name="notice_content" cols="50" rows="15" ><%=rs("notice_content")%></textarea></td>
                                  </tr>
                                  <tr>
                                    <td height="24"><div align="right" class="style10">通知权限：&nbsp;&nbsp;</div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <select name="notice_authority" id="notice_authority">
                                          <option value="public" selected>对外公开</option>
                                          <option value="private">不对外公开</option>
                                        </select>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td width="100" ><div align="right" class="style10">
                                        <div align="center">通知备注：</div>
                                    </div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <textarea name="notice_info" cols="50" rows="10"><%=rs("notice_info")%></textarea>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td height="24"><div align="right" class="style10">
                                        <div align="center">发布时间：</div>
                                    </div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <input name="notice_time" type="text" id="notice_time" value="<%=rs("notice_time")%>">
&nbsp;&nbsp;&nbsp;&nbsp;（格式：2005-05-06）</td>
                                  </tr>
                                  <tr>
                                    <td height="24"><div align="right" class="style10">
                                    ...
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <input type="text" name="notice_author" value="<%=rs("notice_author")%>"></td>
                                  </tr>
                                  <tr>
                                    <td height="35" colspan="2"><div align="center"><img src="../user/userimages/editSub.gif" width="70" height="25" align="absmiddle" style="cursor:hand; " onMouseDown="javascript:submit();"> </div></td>
                                  </tr>
                                </table>
                              </div>
                            </form>
