...
%>
                                    <tr>
                                      <td height="24" colspan="5"><div align="right"> <span class="style2">
                                          ...
                                          <%
if NoncePage>1 then
	response.write "|<a href=site_admin.asp?page=1>首 页</a>| |<a href=site_admin.asp?page="&NoncePage-1&">上一页</a>|&nbsp"
else
	response.write "|首 页| |上一页|&nbsp"
end if
if Cint(Trim(NoncePage))<Cint(Trim(NumPage)) then
	response.write "|<a href=site_admin.asp?page="&NoncePage+1&">下一页</a>| |<a href=site_admin.asp?page="&NumPage&">尾 页</a>|"
else
