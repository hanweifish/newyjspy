                            ...
                            <tr>
                              <td><div align="center">
                                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
								 ...
								 sqlS="select top 6 user_info.user_name,user_info.user_number,sheet.score,sheet.course,sheet.property,sheet.sheet_time,sheet.sheet_academy,sheet.sheet_ID,sheet.tutor,sheet.term,sheet.year from sheet inner join user_info on sheet.user_ID=user_info.user_ID  where sheet.sheet_academy='"&admin_academy&"' order by sheet_time desc"
