                      ...
                      <tr>
                        <td background="../user/userimages/titlebk.gif"><div align="center">
                            <table width="90%"  border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td><form name="form" method="post" action="subject_mod1.asp?page=<%=page%>">
                                    <div align="center">
                                      <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                        <tr>
                                          ...
                                          <td class="style10">&nbsp;&nbsp;&nbsp;
                                              <input name="course" type="text" class="style3" value="<%=rs("course")%>"></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                          ...
                                          <td class="style10">&nbsp;&nbsp;&nbsp;
                                              <input name="credit" type="text" class="style3" value="<%=rs("credit")%>"></td>
                                        </tr>
                                        <tr>
                                          <td height="24"><div align="right"><span class="style10">授课学期：&nbsp;&nbsp;</span></div></td>
                                          <td class="style10">&nbsp;&nbsp;&nbsp;
                                              <input name="term" type="text" class="style3" id="term" value="<%=rs("term")%>"></td>
                                        </tr>
                                         <tr>
                                          <td height="24"><div align="right"><span class="style10">周学时：&nbsp;&nbsp;</span></div></td>
                                          <td class="style10">&nbsp;&nbsp;&nbsp;
                                              <input name="period" type="text" class="style3" id="term" value="<%=rs("period")%>"></td>
                                        </tr>
										 <tr>
                                          <td height="24"><div align="right"><span class="style10">上课人数：&nbsp;&nbsp;</span></div></td>
                                          <td class="style10">&nbsp;&nbsp;&nbsp;
                                              <input name="people" type="text" class="style3" id="term" value="<%=rs("people")%>"></td>
                                        </tr>
                                        <tr>
                                          <td height="24"><div align="right"><span class="style10">教学形式：&nbsp;&nbsp;</span></div></td>
                                          <td class="style10"><div align="left">&nbsp;&nbsp;&nbsp;
                                              <input name="teachway" type="text" class="style3" id="teachway" value="<%=rs("teachway")%>">
                                          </div></td>
                                        </tr>
                                        <tr>
                                          <td height="35" colspan="2"><div align="center"><img src="../user/userimages/editSub.gif" width="70" height="25" align="absmiddle" style="cursor:hand; " onMouseDown="form.submit()"> </div></td>
                                        </tr>
                                      </table>
                                    </div>
                                </form></td>
