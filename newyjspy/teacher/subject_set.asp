...
sql="select * from subject where course_academy='"&admin_academy&"' order by course_ID desc"
...
%>
                                    <table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                      <tr>
                                        <td width="258" height="24"><div align="center" class="style10">课程名称</div></td>
                                        <td width="88"><div align="center"><span class="style10">学期</span></div></td>
                                        <td width="118" height="24"><div align="center" class="style10">授课老师</div></td>
                                        <td width="55" height="24"><div align="center" class="style10">学分</div></td>
										<td width="55" height="24"><div align="center" class="style10">周学时</div></td>
										<td width="95" height="24"><div align="center" class="style10">上课人数</div></td>
...
%>
                                      <tr>
										...
										<td height="24"><div align="center" class="style10"><%=rs("period")%></div></td>
										<td height="24"><div align="center" class="style10"><%=rs("people")%></div></td>
                                        <td width="50" height="24"><div align="center"><a href=subject_mod.asp?page=<%=NoncePage%>&course_ID=<%=rs("course_ID")%>><font color="#ff6633">修改</font></a></div></td>
                                        <td width="50" height="24"><div align="center"><a href=subject_del.asp?page=<%=NoncePage%>&course_ID=<%=rs("course_ID")%>><font color="#ff6633">删除</font></a></div></td>
                                      </tr>
                                      <%rs.movenext
                                            ...
                                            <td><div align="center">
                                              ...
                                              <form name="form1" method="post" action="subject_set.asp">
                                                <div align="right"> <span class="style10">
                                                  <%
if NoncePage>1 then
	response.write "|<a href=subject_set.asp?page=1>首 页</a>| |<a href=subject_set.asp?page="&NoncePage-1&">上一页</a>|&nbsp"
else
	response.write "|首 页| |上一页|&nbsp"
end if
if Cint(Trim(NoncePage))<Cint(Trim(NumPage)) then
	response.write "|<a href=subject_set.asp?page="&NoncePage+1&">下一页</a>| |<a href=subject_set.asp?page="&NumPage&">尾 页</a>|"
else
	response.write "|下一页| |尾 页|"
end if
%>
&nbsp;页次：<font color="#0033CC" class="style3"><%=NoncePage%></font>/<font color="#0033CC"><%=NumPage%></font> 共<font color="#0033CC" class="style3"><%=NumRecord%></font>条记录</span>&nbsp;<span class="style2">&nbsp;跳转到
