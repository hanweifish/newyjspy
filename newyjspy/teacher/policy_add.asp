...
<script language="javascript">
	...
	{
		if (document.form.policy_title.value=="")
		{
			alert("请输入政策标题！");
		}
		else if (document.form.policy_content.value=="")
		{
			alert("请输入政策内容！");
		}
	    else
                    ...
                    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td background="../user/userimages/titlebk.gif"><div align="center">
                            <form name="form" method="post" action="policy_add1.asp" >
                              <div align="center">
                                <table width="90%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                  <tr>
                                    <td height="24"><div align="right" class="style10">政策标题：&nbsp;&nbsp;</div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <input type="text" name="policy_title" size="50"></td>
                                  </tr>
                                  <tr>
                                    <td ><div align="right" class="style10">政策内容：&nbsp;&nbsp;</div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <textarea name="policy_content" cols="50" rows="15"></textarea></td>
                                  </tr>
                                  <tr>
                                    <td height="24"><div align="right" class="style10">政策备注：&nbsp;&nbsp;</div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <textarea name="policy_info" cols="50" rows="10">无</textarea>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td height="24"><div align="right" class="style10">发布人：&nbsp;&nbsp;</div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <input type="text" name="policy_author" size="25"></td>
                                  </tr>
                                  <tr>
