                              ...
                              <tr>
                                <td><div align="center">
                                    <table width="100%"  cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td height="25"><div align="center" class="style10">教务员密码更改</div></td>
                                      </tr>
                                      <tr>
                              ...
                              <tr>
                                <td><div align="center">
                                    <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                                      ...
                                      <tr>
                                        <td height="25" colspan="6"><div align="center" class="style10">教务员信息</div></td>
                                      </tr>
                                      <tr>
                                        <td colspan="6"><table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                            <tr>
                                              ...
                                              <td><div align="center" class="style10">教务员信息</div></td>
                                              <td height="24"><div align="center" class="style10">所属院系</div></td>
											  <td height="24"><div align="center" class="style10">所属院系(英)</div></td>
                                              </tr>
                                           
                                            <tr>
                                              <td width="100" height="24"><div align="center" class="style10"><%=rs("admin_account")%></div></td>
                                              <td><div align="center" class="style10"><%=rs("admin_info")%></div></td>
                                              <td height="24"><div align="center" class="style10"><%=rs("admin_yx")%></div></td>
											  <td height="24"><div align="center" class="style10"><%=rs("admin_academy")%></div></td>
                                              </tr>

                                        </table></td>
                                      </tr>
                                      <tr>
                                        <td height="25" colspan="6"><div align="center"></div></td>
                                      </tr>
                                    </table>
                                </div></td>
                              </tr>
