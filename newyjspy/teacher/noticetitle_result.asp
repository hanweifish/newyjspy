...
sql="select user_info.user_name,user_info.user_number,notice_viewed.viewed_date,notice_viewed.viewed_time,notice.notice_title from user_info inner join (notice_viewed inner join notice on notice_viewed.notice_ID=notice.notice_ID) on user_info.user_account = notice_viewed.user_account where notice.notice_title like '%"&notice_title&"%' order by user_info.user_number"
...
%>
                              <tr>
                                <td height="25" colspan="6"><div align="center" class="style8 style13">通知 <span class="style3">“</span><span class="style16"><%=rs("notice_title")%></span><span class="style3">”</span> 查看记录</div></td>
                              </tr>
                              <tr>
                                <td colspan="6"><table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                    <tr>
                                      <td width="150" height="24"><div align="center" class="style10">查看日期</div></td>
                                      <td height="24"><div align="center" class="style10">查看过此通知的同学</div></td>
                                      <td width="150" height="24"><div align="center" class="style10">学 号</div></td>
                                      <td width="100" height="24"><div align="center" class="style10">查看次数</div></td>
                                    </tr>
                                    <%
...
%>
                                    <tr>
                                      ...
                                      <td height="24"><div align="center" class="style10"><%=rs("user_name")%></div></td>
...
%>
                                    <tr>
                                      <td height="24" colspan="8"><div align="right"> <span class="style10">
                                          ...
                                          <%
if NoncePage>1 then
	response.write "|<a href=noticetitle_result.asp?page=1&notice_title="&notice_title&">首 页</a>| |<a href=noticetitle_result.asp?page="&NoncePage-1&"&notice_title="&notice_title&">上一页</a>|&nbsp"
else
	response.write "|首 页| |上一页|&nbsp"
end if
if Cint(Trim(NoncePage))<Cint(Trim(NumPage)) then
	response.write "|<a href=noticetitle_result.asp?page="&NoncePage+1&"&notice_title="&notice_title&">下一页</a>| |<a href=noticetitle_result.asp?page="&NumPage&"&notice_title="&notice_title&">尾 页</a>|"
else
	response.write "|下一页| |尾 页|"
end if
%>
                                      </span> <span class="style2">&nbsp;页次：</span><span class="style3"><%=NoncePage%></span><span class="style2">/</span><span class="style2"><%=NumPage%> </span><span class="style2">共</span><span class="style3"><%=NumRecord%></span><span class="style2">条记录&nbsp;</span> </div></td>
                                    </tr>
                                </table></td>
                              </tr>
                              <%
