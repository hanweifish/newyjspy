...
sql="select * from policy order by policy_time desc"
...
%>
                                    <table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                      <tr>
                                        ...
                                        <td width="321" height="24"><div align="center" class="style10">政策标题</div></td>
...
%>
                                      <tr>
                                        <td width="200" height="24"><div align="left" class="style10">&nbsp;&nbsp;<%=rs("policy_time")%></div></td>
                                        <td height="24"><div align="left" class="style10">&nbsp;&nbsp;<%=rs("policy_title")%></div></td>
                                        <td width="50" height="24"><div align="center"><a href=policy_mod.asp?policy_ID=<%=rs("policy_ID")%>><font color="#ff6633">修改</font></a></div></td>
                                        <td width="50" height="24"><div align="center"><a href=policy_del.asp?policy_ID=<%=rs("policy_ID")%>><font color="#ff6633">删除</font></a></div></td>
                                      </tr>
                                      <%rs.movenext
...
%>
                                      <tr>
                                        <td height="24" colspan="8"><div align="right" class="style2"> <span class="style10">
                                            ...
                                            <%
if NoncePage>1 then
	response.write "|<a href=policy_set.asp?page=1>首 页</a>| |<a href=policy_set.asp?page="&NoncePage-1&">上一页</a>|&nbsp"
else
	response.write "|首 页| |上一页|&nbsp"
end if
if Cint(Trim(NoncePage))<Cint(Trim(NumPage)) then
	response.write "|<a href=policy_set.asp?page="&NoncePage+1&">下一页</a>| |<a href=policy_set.asp?page="&NumPage&">尾 页</a>|"
else
