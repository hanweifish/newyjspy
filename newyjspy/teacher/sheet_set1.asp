...
Response.write "<script>alert('本学期成绩登录尚未开始！');history.go(-1);</script>"
end if
%>
<%
if today > enddate or sel = "no" then
Response.write "<script>alert('本学期成绩登录已结束或已中止！');history.go(-1);</script>"
end if
%>
                      ...
                      <tr>
                        <td background="../user/userimages/titlebk.gif"><div align="center">
                            <table width="90%"  cellspacing="0" cellpadding="0">
                              <tr>
                                <td><form action="sheet_result.asp" method="post" name="form" id="form">
                                    <table width="100%" border="1" cellpadding="0"  cellspacing="0" bordercolor="#000000" class="thin">
                                      <tr valign="bottom">
                                        <td width="34%" height="25"><div align="right" class="style18">按&nbsp; </div></td>
                                        <td width="66%" height="30"><div align="left" class="style18">
                                            <div align="left">
                                  ...
                                  查询</div>
                                      ...
                                      <tr valign="bottom">
                                        <td height="25"><div align="right" class="style18">请输入关键字：</div></td>
                                        <td height="30"><div align="left">
                                            <input name="keywords" type="text" class="style3" size="30">
&nbsp;&nbsp;&nbsp;<img src="../user/userimages/search.gif" width="46" height="23" align="absmiddle" style="cursor:hand; " onMouseDown="checksearch(form)"> </div></td>
                                      </tr>
                                    </table>
                                </form></td>
                              </tr>
