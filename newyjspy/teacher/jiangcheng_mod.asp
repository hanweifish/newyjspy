                    ...
                    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td height="86" background="adminimages/titlebk2.gif"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td height="45"><div align="center">编辑奖惩信息</div></td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
                        <td background="../user/userimages/titlebk.gif"><div align="center">
                            <form name="form" method="post" action="jiangcheng_mod1.asp?jiangcheng_ID=<%=jiangcheng_ID%>">
                              <div align="center">
                                <table width="90%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                  <tr>
                                    <td width="100" height="24"><div align="right" class="style10">
                                        <div align="center">学 号：</div>
                                    </div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <input name="user_number" type="text" id="user_number" value="<%=rs("user_number")%>"></td>
                                  </tr>
                                  <tr>
                                    <td width="100" ><div align="right" class="style10">
                                        <div align="center">奖惩内容：</div>
                                    </div></td>
                                    <td height="25" class="style10">&nbsp;&nbsp;&nbsp;
                                      <input name="record" type="text" id="record" value="<%=rs("record")%>" size="55"></td>
                                  </tr>
                                  <tr>
