...
sheet_yx=rsSubject("course_yx")
sheet_academy=rsSubject("course_academy")
...
<%
	...
	sheet1=rs("sheet_ID")
    Response.Redirect "sheet_mod.asp?sheet_ID="&sheet1
	else
    rs.addnew
    ...
    rs("tutor")=tutor
	rs("term")=term
    rs("sheet_academy")=sheet_academy
	rs("sheet_yx")=sheet_yx
