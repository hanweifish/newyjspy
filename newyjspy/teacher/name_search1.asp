                                      ...
                                      <tr>
                                        <td><div align="center">
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                              ...
                                              <tr>
                                                <td height="24"><div align="right" class="style10">入学报到：&nbsp;&nbsp;</div></td>
                                                <td class="style10">&nbsp;&nbsp;&nbsp; <%=rs("user_rxbd")%> 时间：<%=rs("user_rxbd1")%></td>
                                              </tr>
                                              <tr>
                                                <td height="24"><div align="right" class="style10">放弃入学资格：&nbsp;&nbsp;</div></td>
                                                <td class="style10">&nbsp;&nbsp;&nbsp; <%=rs("user_fqrxzg")%> </td>
                                              </tr>
                                              <tr>
                                                <td height="24"><div align="right" class="style10">保留入学资格：&nbsp;&nbsp;</div></td>
                                                <td class="style10">&nbsp;&nbsp;&nbsp; <%=rs("user_blrxzg")%> 日期：<%=rs("user_blrxzg1")%>至<%=rs("user_blrxzg2")%> 原因：<%=rs("user_blrxzg3")%></td>
                                              </tr>
                                              <tr>
                                                <td height="24"><div align="right" class="style10">取消入学资格：&nbsp;&nbsp;</div></td>
                                                <td class="style10">&nbsp;&nbsp;&nbsp; <%=rs("user_qxrxzg")%> 日期：<%=rs("user_qxrxzg1")%>至<%=rs("user_qxrxzg2")%> 原因：<%=rs("user_qxrxzg3")%></td>
                                              </tr>
                                              <tr>
                                                <td height="24"><div align="right" class="style10">休学：&nbsp;&nbsp;</div></td>
                                                <td class="style10">&nbsp;&nbsp;&nbsp; <%=rs("user_xx")%> 日期：<%=rs("user_xx1")%>至<%=rs("user_xx2")%> 原因：<%=rs("user_xx3")%></td>
                                              </tr>
                                              <tr>
                                                <td height="24"><div align="right" class="style10">复学：&nbsp;&nbsp;</div></td>
                                                <td class="style10">&nbsp;&nbsp;&nbsp; <%=rs("user_fx")%> 日期：<%=rs("user_fx1")%></td>
                                              </tr>
                                              <tr>
                                                <td height="24"><div align="right" class="style10">转专业：&nbsp;&nbsp;</div></td>
                                                <td class="style10">&nbsp;&nbsp;&nbsp; <%=rs("user_zzy")%> 转入专业：<%=rs("user_zzy1")%> 转专业期间：<%=rs("user_zzy2")%></td>
                                              </tr>
                                              <tr>
                                                <td height="24"><div align="right" class="style10">转院系：&nbsp;&nbsp;</div></td>
                                                <td class="style10">&nbsp;&nbsp;&nbsp; <%=rs("user_zyx")%> 转入院系：<%=rs("user_zyx1")%> 转院系期间：<%=rs("user_zyx2")%></td>
                                              </tr>
                                              <tr>
                                                <td height="24"><div align="right" class="style10">转导师：&nbsp;&nbsp;</div></td>
                                                <td class="style10">&nbsp;&nbsp;&nbsp; <%=rs("user_zds")%> 现导师：<%=rs("user_zds1")%> 转导师期间：<%=rs("user_zds2")%></td>
                                              </tr>
                                              <tr>
                                                <td height="24"><div align="right" class="style10">提前毕业：&nbsp;&nbsp;</div></td>
                                                <td class="style10">&nbsp;&nbsp;&nbsp; <%=rs("user_tqby")%> 提前毕业时间：<%=rs("user_tqby")%></td>
                                              </tr>
                                              <tr>
                                                <td height="24"><div align="right" class="style10">恢复正常毕业：&nbsp;&nbsp;</div></td>
                                                <td class="style10">&nbsp;&nbsp;&nbsp; <%=rs("user_hfzcby")%> 办理时间：<%=rs("user_hfzcby1")%> 原因：<%=rs("user_hfzcby2")%></td>
                                              </tr>
                                              <tr>
                                                <td height="24"><div align="right" class="style10">延期毕业：&nbsp;&nbsp;</div></td>
                                                <td class="style10">&nbsp;&nbsp;&nbsp; <%=rs("user_yqby")%> 延期毕业办理日期：<%=rs("user_yqby1")%></td>
                                              </tr>
                                              <tr>
                                                <td height="24"><div align="right" class="style10">退学：&nbsp;&nbsp;</div></td>
                                                <td class="style10">&nbsp;&nbsp;&nbsp; <%=rs("user_tx")%> 退学办理时间：<%=rs("user_tx1")%> 退学原因：<%=rs("user_tx2")%></td>
                                              </tr>
                                              <tr>
                                                <td height="24"><div align="right" class="style10">取消学籍：&nbsp;&nbsp;</div></td>
                                                <td class="style10">&nbsp;&nbsp;&nbsp; <%=rs("user_qxxj")%> 办理时间：<%=rs("user_qxxj1")%> 原因：<%=rs("user_qxxj2")%></td>
                                              </tr>
                                              <tr>
                                                <td height="24"><div align="right" class="style10">肄业：&nbsp;&nbsp;</div></td>
                                                <td class="style10">&nbsp;&nbsp;&nbsp; <%=rs("user_yy")%> 肄业办理日期：<%=rs("user_yy1")%></td>
                                              </tr>
                                              <tr>
                                                <td height="24"><div align="right" class="style10">正常毕业：&nbsp;&nbsp;</div></td>
                                                <td class="style10">&nbsp;&nbsp;&nbsp; <%=rs("user_zcby")%> 正常毕业办理日期：<%=rs("user_zcby1")%></td>
                                              </tr>
                                              <tr>
                                                <td height="24"><div align="right" class="style10">结业：&nbsp;&nbsp;</div></td>
                                                <td class="style10">&nbsp;&nbsp;&nbsp; <%=rs("user_jy")%> 结业办理日期：<%=rs("user_jy1")%></td>
                                              </tr>
                                              <tr>
                                                <td height="24"><div align="right" class="style10">答辩：&nbsp;&nbsp;</div></td>
                                                <td class="style10">&nbsp;&nbsp;&nbsp; <%=rs("user_db")%> 答辩日期：<%=rs("user_db1")%></td>
                                              </tr>
                                              <tr>
                                                <td height="24"><div align="right" class="style10">提前攻博：&nbsp;&nbsp;</div></td>
                                                <td class="style10">&nbsp;&nbsp;&nbsp; <%=rs("user_tqgb")%> 提前攻博办理日期：<%=rs("user_tqgb1")%></td>
                                              </tr>
                                              <tr>
                                                <td height="24"><div align="right" class="style10">终止提前攻博：&nbsp;&nbsp;</div></td>
                                                <td class="style10">&nbsp;&nbsp;&nbsp; <%=rs("user_zztqgb")%> 终止提前攻博办理日期：<%=rs("user_zztqgb1")%> 原因：<%=rs("user_zztqgb2")%></td>
                                              </tr>
                                              <tr>
                                                <td height="24"><div align="right" class="style10">公派出国：&nbsp;&nbsp;</div></td>
                                                <td class="style10">&nbsp;&nbsp;&nbsp; <%=rs("user_gpcg")%> 公派出国办理日期：<%=rs("user_gpcg1")%> 公派出国派往国：<%=rs("user_gpcg2")%></td>
                                              </tr>
                                              <tr>
                                                <td height="24"><div align="right" class="style10">乘车区间：&nbsp;&nbsp;</div></td>
                                                <td class="style10">&nbsp;&nbsp;&nbsp; <%=rs("user_ccqj")%></td>
                                              </tr>
                                              <tr>
                                                <td height="24"><div align="right" class="style10">姓名更改：&nbsp;&nbsp;</div></td>
                                                <td class="style10">&nbsp;&nbsp;&nbsp; <%=rs("user_xmgg")%> 原名：<%=rs("user_xmgg1")%> 现名：<%=rs("user_xmgg2")%> 更改时间：<%=rs("user_xmgg3")%></td>
                                              </tr>
                                              <tr>
                                                <td height="24"><div align="right" class="style10">出生日期更改：&nbsp;&nbsp;</div></td>
                                                <td class="style10">&nbsp;&nbsp;&nbsp; <%=rs("user_cxrqgg")%> 原日期：<%=rs("user_cxrqgg1")%> 现日期：<%=rs("user_cxrqgg")%> 更改时间：<%=rs("user_cxrqgg3")%></td>
                                              </tr>
                                              <tr>
                                                <td height="24"><div align="right" class="style10">身份证号更改：&nbsp;&nbsp;</div></td>
                                                <td class="style10">&nbsp;&nbsp;&nbsp; <%=rs("user_sfzhgg")%> 原号码：<%=rs("user_sfzhgg1")%> 现号码：<%=rs("user_sfzhgg2")%> 更改时间：<%=rs("user_sfzhgg3")%></td>
                                              </tr>
                                              <tr>
