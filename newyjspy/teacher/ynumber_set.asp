                                  ...
                                  <tr>
                                    <td colspan="6"><div align="center">
                                        <table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                          <tr>
                                            <td height="24"><div align="center" class="style10">研一起始学号</div></td>
                                            <td height="24"><div align="center" class="style10">研一终止学号</div></td>
                                            <td height="24"><div align="center" class="style10">研二起始学号</div></td>
                                            <td height="24"><div align="center" class="style10">研二终止学号</div></td>
                                            <td height="24"><div align="center" class="style10">研三起始学号</div></td>
                                            <td height="24"><div align="center" class="style10">研三终止学号</div></td>
                                          </tr>
                                          <tr>
                                            <td height="24"><div align="center" class="style10"><%=rs("yanyi_bg")%></div></td>
                                            <td height="24"><div align="center" class="style10"><%=rs("yanyi_end")%></div></td>
                                            <td height="24"><div align="center" class="style10"><%=rs("yaner_bg")%></div></td>
                                            <td height="24"><div align="center" class="style10"><%=rs("yaner_end")%></div></td>
                                            <td height="24"><div align="center" class="style10"><%=rs("yansan_bg")%></div></td>
                                            <td height="24"><div align="center"class="style10"><%=rs("yansan_end")%></div></td>
                                          </tr>
                                        </table>
                                    </div></td>
                                  </tr>
                                  <tr>
                                    <td height="35" colspan="6"><div align="center"><a href="ynumber_mod.asp" class="style6"><img src="../user/userimages/edit.gif" border="0" class="style2"></a></div></td>
                                  </tr>
                                </table>
                            </div></td>
                          </tr>
