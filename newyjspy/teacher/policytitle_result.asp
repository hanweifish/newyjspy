...
%>
                              <tr>
                                <td height="25" colspan="6"><div align="center" class="style8 style13">政策 <span class="style3">“</span><span class="style16"><%=rs("policy_title")%></span><span class="style3">”</span> 查看记录</div></td>
                              </tr>
                              <tr>
                                <td colspan="6"><table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                    <tr>
                                      ...
                                      <td height="24"><div align="center" class="style10">查看过此政策的同学</div></td>
...
%>
                                    <tr>
                                      <td height="24" colspan="8"><div align="right"> <span class="style10">
                                          ...
                                          <%
if NoncePage>1 then
	response.write "|<a href=policytitle_result.asp?page=1&policy_title="&policy_title&">首 页</a>| |<a href=policytitle_result.asp?page="&NoncePage-1&"&policy_title="&policy_title&">上一页</a>|&nbsp"
else
	response.write "|首 页| |上一页|&nbsp"
end if
if Cint(Trim(NoncePage))<Cint(Trim(NumPage)) then
	response.write "|<a href=policytitle_result.asp?page="&NoncePage+1&"&policy_title="&policy_title&">下一页</a>| |<a href=policytitle_result.asp?page="&NumPage&"&policy_title="&policy_title&">尾 页</a>|"
else
