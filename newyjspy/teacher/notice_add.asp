...
<script language="javascript">
	...
	{
		if (document.form.notice_title.value=="")
		{
			alert("请输入通知标题！");
		}
		else if (document.form.notice_content.value=="")
		{
			alert("请输入通知内容！");
		}
	    else
                    ...
                    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td background="../user/userimages/titlebk.gif"><div align="center">
                            <form name="form" method="post" action="notice_add1.asp" >
                              <div align="center">
                                <table width="90%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                  <tr>
                                    ...
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <input type="text" name="notice_title" size="50"></td>
                                  </tr>
                                  <tr>
                                    <td ><div align="right" class="style10">通知内容：&nbsp;&nbsp;</div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <textarea name="notice_content" cols="50" rows="15"></textarea></td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <textarea name="notice_info" cols="50" rows="10">无</textarea>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td height="24"><div align="right" class="style10">发布人：&nbsp;&nbsp;</div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <input type="text" name="notice_author" size="25"></td>
                                  </tr>
                                  <tr>
