...
sqlS="select user_info.user_id,user_info.user_number,scholarship_info.scholarship_prize,scholarship_info.scholarship_info,scholarship_info.scholarship_sorts,scholarship_info.scholarship_id from scholarship_info inner join user_info on scholarship_info.user_ID=user_info.user_ID where scholarship_info.scholarship_id='"&scholarship_id&"'"
                      ...
                      <tr>
                        <td height="54" background="adminimages/titlebk1.gif"><div align="center">
                            <table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td><div align="center"><a href="scholarship_info.asp"><img src="adminimages/train.gif" width="170" height="24" border="0"></a></div></td>
                              </tr>
                            </table>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="86" background="adminimages/titlebk2.gif"><div align="center" class="style10">奖学金申请</div></td>
                      </tr>
                      <tr>
                              ...
                              <tr>
                                <td><div align="center">
                                    <table width="100%"  cellspacing="0" cellpadding="0">
                                      ...
                                      <tr>
                                        <td><form action="scholarship_infomod1.asp" method="post" name="form" onSubmit="return checkform(form)">
                                            <div align="center">
                                        ...
                                        <td class="style10">&nbsp;&nbsp;&nbsp;
                                            ...
                                            <input name="user_number" type="text" class="style3" value="<%=rsS("user_number")%>" >
                                                                           </td>
                                      </tr>
										 <tr>
                                        <td height="24"><div align="right" class="style10">获奖名称：&nbsp;&nbsp;</div></td>
                                        <td class="style10">&nbsp;&nbsp;&nbsp;
                                            <input name="scholarship_sorts" type="text" class="style3" value="<%=rsS("scholarship_sorts")%>"></td>
                                      </tr>	
									  <tr>
                                        <td height="24"><div align="right" class="style10">获奖奖励：&nbsp;&nbsp;</div></td>
                                        <td class="style10">&nbsp;&nbsp;&nbsp;
                                            <input name="scholarship_prize" type="text" class="style3" value="<%=rsS("scholarship_prize")%>"></td>
                                      </tr>	
									  <tr>
                                        <td height="24"><div align="right" class="style10">附加信息：&nbsp;&nbsp;</div></td>
                                        <td class="style10">&nbsp;&nbsp;&nbsp;
                                           <textarea name="scholarship_info" cols="45" rows="10" class="style3" value="<%=rsS("scholarship_info")%>">无</textarea></td>
                                      </tr>		
                                           <tr>
                                        <td height="24"><div align="right" class="style10">所在院系：&nbsp;&nbsp;</div></td>
                                        <td class="style10">&nbsp;&nbsp;&nbsp;
                                            <%=rs("admin_yx")%><input type="hidden" name="admin_academy" value="<%=rs("admin_academy")%>"></td>
                                      </tr>	     
                                                <tr>
