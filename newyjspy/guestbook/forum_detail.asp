    ...
    <tr>
      ...
      <td colspan="2"><div align="center">
        <table width="85%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="50"><div align="left"><img src="../images/rotate.gif" width="11" height="11"><span class="style8">&nbsp;留 言 板 &gt;&gt; </span><span class="style1"><a href="index.asp" target="_parent"><font class="style2">查 看 留 言</font></a> &gt;&gt; <a href="reply.asp?forum_ID=<%=forum_ID%>"><font class="style2">回 复 本 文</font></a></span></div></td>
          </tr>
          <tr>
...
%>
          <tr>
			...
			<%if right(rs2("user_account"),7)= right(session("user_account"),7) then%>
			<a href="postedit.asp?forum_ID=<%=rs2("forum_ID")%>"><font class="style2">编辑</font></a>
			<%end if%>
			</div></td>
          </tr>
          <tr>
...
%>		  
		  <tr>
            <td height="25"><div align="left">by <%=rs3("user_account")%>&nbsp;&nbsp; <%=rs1("reforum_time")%>&nbsp;&nbsp; RE"<%=rs2("forum_title")%>"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
              <%if right(rs3("user_account"),7)=right(session("user_account"),7) then%>
              <a href="replyedit.asp?reforum_ID=<%=rs1("reforum_ID")%>"><font class="style2">编辑</font></a>
              <%end if%>
</div></td>
          </tr>
          <tr>
...
%>		  
          <tr>
            <td height="30"><div align="center"><a href="index.asp">返 回</a>
              </div></td>
          </tr>
        </table>
          </div></td>
