    ...
    <tr>
      ...
      <td colspan="2"><div align="center">
        <table width="85%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="50"><div align="left"><span class="style8"><img src="../images/dot4.gif" width="11" height="11"> 留 言 板 &gt;&gt; </span><span class="style1"><a href="post.asp" target="_parent">我要留言</a></span></div></td>
          </tr>
<%
	...
	%>
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="40" height="24" bgcolor="#CCCCCC"><div align="left">删 除</div></td>
                  </tr>
                  <%
		if Not(rs.eof and rs.bof) then
		...
		%>
                    ...
                    <td width="430" height="24"><div align="left"><img src="../images/dot4.gif" width="11" height="11">&nbsp;<a href="admin_forum_detail.asp?forum_ID=<%=rs("forum_ID")%>"><%=rs("forum_title")%></a></div></td>
                    <td width="40" height="24"><div align="left"><a href="admin_del.asp?forum_ID=<%=rs("forum_ID")%>&page=<%=NouncePage%>" class="style2">删 除</a></div></td>
                    <%
		else 
		%>
                    ...
                    <td width="430" height="24" bgcolor="#F0F0F0"><div align="left"><img src="../images/dot4.gif" width="11" height="11">&nbsp;<a href="admin_forum_detail.asp?forum_ID=<%=rs("forum_ID")%>"><%=rs("forum_title")%></a></div></td>
                    <td width="40" height="24" bgcolor="#F0F0F0"><div align="left"><a href="admin_del.asp?forum_ID=<%=rs("forum_ID")%>&page=<%=NouncePage%>" class="style2">删 除</a></div></td>
                    <%
		end if
		%>
                  </tr>
			...
			Response.Write("<tr><td height = '24' colspan='4'><div align = 'center'><marquee scrolldelay=120 behavior=alternate>清在此发表留言！</marquee></div></td></tr>")
		end if
		rs.close
		set rs=nothing
		%>
		  ...
		  Response.Write("|<a href = 'admin_index.asp?page=1'>首页</a>||<a href = 'admin_index.asp?page="&NouncePage-1&"'>上一页</a>|&nbsp;")
		  else
		  Response.Write("|首页||上一页|&nbsp;")
		  end if
		  if Cint(NouncePage)< Cint(NumPage) then
		  Response.Write("|<a href = 'admin_index.asp?page="&NouncePage+1&"'>下一页</a>||<a href = 'admin_index.asp?page="&NumPage&"'>尾页</a>|&nbsp")
		  else
