        ...
        <tr>
          <td colspan="3"><div align="center">
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="53" align="right" background="user/userimages/titlebk2.gif"><div align="center"></div></td>
                </tr>
                <tr>
                  <td background="user/userimages/titlebk.gif"><div align="center" class="style13">
                    <table width="90%"  border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td><form action="site_mod.asp" method="post" name="form1" id="form1">
                            <div align="center">
                              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td width="120" height="24"><div align="right" class="style10">用户名：&nbsp;&nbsp;</div></td>
                                  <td width="261" class="style10">&nbsp;&nbsp;&nbsp;
                                      <input name="site_admin" type="text" class="style3" id="site_admin" value="<%=rs("site_admin")%>" size="24">
                                      <span class="style12">*</span> </td>
                                  </tr>
                                <tr>
                                  <td width="120" height="24"><div align="right" class="style10">密码：&nbsp;&nbsp;</div></td>
                                  <td class="style10">&nbsp;&nbsp;&nbsp;
                                      <input name="site_pwd" type="text" class="style3" id="site_pwd" value="<%=rs("site_pwd")%>" size="24">
                                      <span class="style12">*</span> </td>
                                </tr>
                                <tr>
                                  <td width="120" height="24"><div align="right" class="style10">站 名：&nbsp;&nbsp;</div></td>
                                  <td class="style10">&nbsp;&nbsp;&nbsp;
                                      <input name="site_name" type="text"class="style3" id="site_name" value="<%=rs("site_name")%>" size="24">
                                      <span class="style12">*</span> </td>
                                </tr>
                                <tr>
                                  <td width="120" height="24"><div align="right" class="style10">地 址(url)：&nbsp;&nbsp;</div></td>
                                  <td class="style10">&nbsp;&nbsp;&nbsp;
                                      <input name="site_url" type="text" class="style3" id="site_url" value="<%=rs("site_url")%>" size="24">
                                      <span class="style12">*</span> </td>
                                </tr>
                                <tr>
                                  <td width="120" height="24"><div align="right" class="style10">备注信息：&nbsp;&nbsp;</div></td>
                                  <td class="style10">&nbsp;&nbsp;&nbsp;
                                    <textarea name="site_info" cols="30" rows="4" id="site_info"><%=rs("site_info")%></textarea></td>
                                </tr>
                                <tr>
                                  <td height="35" colspan="2"><div align="center"><img src="user/userimages/edit.gif" width="55" height="25" style="cursor:hand;" onMouseDown="javascript:submit();">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="site_logout.asp"><img src="includeimages/logout.gif" width="55" height="25" border="0"></a></div></td>
                                </tr>
                              </table>
                            </div>
                            <table width="100%">
