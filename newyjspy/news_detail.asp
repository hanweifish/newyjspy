                                ...
                                <tr>
                                  <td><div align="center">
                                    <table width="80%"  border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td width="39%" height="20" class="style9">发布人：<%=rsn("news_author")%></td>
                                          <td width="17%" class="style9"><div align="right"></div></td>
                                          <td width="44%" class="style9"><div align="right">发布时间：<%=rsn("news_time")%>&nbsp;&nbsp;</div></td>
                                        </tr>
                                        <tr>
...
&nbsp;</td>
                                        ...
                                        <tr>
                                          <td height="25" colspan="3" class="style2">备注信息：</td>
                                        </tr>
                                        <tr>
