...
%>
                              <tr>
                                ...
                                <td height="25"><div align="left"></div>
                                    <div align="left">&nbsp;&nbsp;&nbsp;&nbsp;<a href=policy_detail.asp?policy_ID=<%=rsn("policy_ID")%> target="_blank" class="style3"><%=rsn("policy_title")%></a></div></td>
                              </tr>
                              <%rsn.movenext
...
%>
                              <tr>
                                <td height="24" colspan="8" align="center" valign="middle"><div align="right"><span class="style2">
                                    ...
                                    <%
if NoncePage>1 then
	response.write "|<a href=policylist.asp?page=1>首 页</a>| |<a href=policylist.asp?page="&NoncePage-1&">上一页</a>|&nbsp"
else
	response.write "|首 页| |上一页|&nbsp"
end if
if Cint(Trim(NoncePage))<Cint(Trim(NumPage)) then
	response.write "|<a href=policylist.asp?page="&NoncePage+1&">下一页</a>| |<a href=policylist.asp?page="&NumPage&">尾 页</a>|"
else
