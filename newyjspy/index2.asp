  ...
  <tr>
    ...
    <td rowspan="7" valign="top"><div align="right">
      <table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="22"><div align="right">您是本网站第
              <%read_%> <script language="javascript" src="counter.asp"></script>
              位访客&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
        </tr>
        <tr>
                ...
                <td><table width="100%" height="120" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td background="indeximages/noticeBk.gif"><div align="center">
                          <iframe src="notice.asp" name="notice" width="350" marginwidth="0" height="200" marginheight="0" align="middle" scrolling="yes" frameborder="0" allowtransparency="true"></iframe>
                      </div></td>
                    </tr>
                    <tr>
...
<!--#include file="bulletin.asp"-->
              ...
              <tr>
                ...
                <td width="6" background="indeximages/midLinkBt.gif">&nbsp;</td>
