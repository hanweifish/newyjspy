...
%>
                                    <table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                      <tr>
                                        <td width="100" height="24"><div align="center" class="style10">发表日期</div></td>
                                        <td width="75"><div align="center">发布人</div></td>
                                        <td width="307" height="24"><div align="center" class="style10">通知标题</div></td>
                                        <td width="51" height="24"><div align="center" class="style10">删除</div>
...
%>
                                      <tr>
                                        <td width="100" height="24"><div align="left" class="style10">&nbsp;&nbsp;<%=rst("tongzhi_time")%></div></td>
                                        <td><div align="center"><span class="style10"><%=rst("tongzhi_author")%></span></div></td>
                                        <td height="24"><div align="left" class="style10">&nbsp;&nbsp;<%=rst("tongzhi_title")%></div></td>
                                        <td height="24"><div align="center"><a href=tongzhi_del.asp?tongzhi_ID=<%=rst("tongzhi_ID")%>><font color="#ff6633">删除</font></a></div>
