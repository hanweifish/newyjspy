...
sql2="select * from admin_info where admin_account='"&admin_account&"'"
                      ...
                      <tr>
                        <td height="54" background="adminimages/titlebk1.gif"><div align="center">
                            <table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td><div align="center"><a href="sheet_set.asp"></a></div></td>
                                <td><div align="center"><a href="subject_set.asp"></a></div></td>
                                <td><div align="center"><a href="sheet_add.asp"></a></div></td>
                                <td><div align="center"><a href="subject_add.asp"></a></div></td>
                              </tr>
                            </table>
                        </div></td>
                      </tr>
                      ...
                      <tr>
                        <td valign="top" background="../user/userimages/titlebk.gif"><div align="center">
                          <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td><div align="center">
                                <form name="form" method="post" action="sheet_add3.asp" onSubmit="return checkcourse(form)">
                                  <div align="center">
                                      ...
                                      <tr>
                                        ...
                                        <td class="style10">&nbsp;&nbsp;&nbsp;
											...
											<%
												...
												set rs1=server.createobject("adodb.recordset")
												sql1="select * from subject where academy='"&admin_academy&"'order by course "
												rs1.open sql1,conn,1,1
												end if
												%>
								 ...
								 %>
										  ...
										  (06:第一学年；05：第二学年；04：第三学年)</label></td>
                                      </tr>
									  <tr>
                                        <td height="24"><div align="right"><span class="style10">修读学期：&nbsp;&nbsp;</span></div></td>
                                        <td class="style10">&nbsp;&nbsp;&nbsp; <label>
                            ...
                            <tr>
                              <td><div align="center">
                                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
								 ...
								 sqlS="select top 6 user_info.user_name,user_info.user_number,sheet.score,sheet.course,sheet.property,sheet.sheet_time,sheet.sheet_ID,sheet.tutor,sheet.term,sheet.year from sheet inner join user_info on sheet.user_ID=user_info.user_ID order by sheet_time desc"
								 ...
								 %>
								  <tr class="style10">
									...
									<td><div align="center">任课老师</div></td>
                                    <td><div align="center">成绩</div></td>
                                    <td><div align="center">课程性质</div></td>
									<td><div align="center">修读时间</div></td>
								 ...
								 %>
								  <tr class="style10">
									...
									<td><div align="center"><%=rsS("tutor")%></div></td>
                                    <td><div align="center"><%=rsS("score")%></div></td>
                                    <td><div align="center"><%=rsS("property")%></div></td>
									<td><div align="center"><%=rsS("year")%><%=rsS("term")%></div></td>
                                    <td class="style3"><div align="center"><a href=sheet_mod.asp?sheet_ID=<%=rsS("sheet_ID")%> class=style3 ></a></div></td>
                                    <td class="style3"><div align="center"><a href=sheet_del.asp?sheet_ID=<%=rsS("sheet_ID")%> class=style3 ></a></div></td>
								  </tr>
								  <%
								  rsS.movenext
