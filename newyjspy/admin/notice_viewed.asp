...
<script language="javascript">
	function checkform1()
	{
		if (document.form1.notice_title.value=="")
		{
			alert("请输入通知标题！");
		}
		else
                      ...
                      <tr>
                        <td background="../user/userimages/titlebk.gif"><div align="center">
                            <table width="100%" cellpadding="0" cellspacing="0" >
                              <tr>
                                <td><form name="form" method="post" action="noticename_result.asp" onsubmit="return checkform()">
                                    <div align="center"> <br>
                                        <br>
                                        <table width="95%" height="50" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin" >
                                          <tr valign="middle">
                                            <td width="180" height="35"><div align="right" class="style3">按姓名查询：</div></td>
                                            <td><div align="center">
                                          ...
                                          <tr valign="middle">
                                            <td colspan="3"><div align="center" class="style3">查看单个学生浏览过的通知</div></td>
                                          </tr>
                                        </table>
                                    </div>
                                </form></td>
                              ...
                              <tr>
                                <td><div align="center">
                                    <form name="form1" method="post" action="noticetitle_result.asp" onsubmit="return checkform1()">
                                      <div align="center">
                                        <table width="95%" height="50" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin" >
                                          <tr valign="middle">
                                            <td width="180" height="35"><div align="right" class="style3">按通知查询：</div></td>
                                            <td><div align="center">
                                                <input name="notice_title" type="text" class="style3" id="notice_title" size="32">
                                            </div></td>
                                          ...
                                          <tr valign="middle">
                                            <td colspan="3"><div align="center" class="style3">查看某条通知的浏览情况</div></td>
                                          </tr>
                                        </table>
                                      </div>
                                    </form>
