                              ...
                              <tr>
                                <td><div align="center">
                                    <table width="100%"  cellspacing="0" cellpadding="0">
                                      ...
                                      <tr>
                                        <td><form action="train_mod1.asp" method="post" name="form" id="form" onSubmit="return checkform()">
                                            <div align="center">
									...
									%>                                        </td>
									  ...
									  <tr>
                                        ...
                                        <td class="style10">&nbsp;&nbsp;&nbsp;
                                            <%=rs2("train_academy")%><input type="hidden" name="train_academy" value="<%=rs("admin_academy")%>"></td>
                                      </tr>	     
                                                <tr>
