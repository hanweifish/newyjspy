...
sql="select * from teacher_info order by admin_account"
                      ...
                      <tr>
                        <td height="54" background="adminimages/titlebk1.gif"><div align="center">
                            <table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td><div align="center"><img src="adminimages/teacher.gif" width="170" height="24"></div></td>
                              </tr>
                            </table>
                        </div></td>
                      </tr>
                              ...
                              <tr>
                                <td><div align="center">
                                    <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                                      ...
                                      <tr>
                                        <td height="25" colspan="6"><div align="center" class="style10">教务员信息列表</div></td>
                                      </tr>
                                      <tr>
                                        <td colspan="6"><table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                            <tr>
                                              ...
                                              <td><div align="center" class="style10">密码</div></td>
                                              <td height="24"><div align="center" class="style10">所属院系</div></td>
											  <td height="24"><div align="center" class="style10">补充信息</div></td>
...
%>
                                            <tr>
                                              <td width="100" height="24"><div align="center" class="style10"><%=rs("admin_account")%></div></td>
                                              <td><div align="center" class="style10"><%=rs("admin_pwd")%></div></td>
                                              <td height="24"><div align="center" class="style10"><%=rs("admin_yx")%></div></td>
											  <td height="24"><div align="center" class="style10"><%=rs("admin_info")%></div></td>
                                              <td width="50" height="24"><div align="center"><a href=teacher_mod.asp?admin_ID=<%=rs("admin_ID")%>><font color="#ff6633">修改</font></a></div></td>
                                              <td width="50" height="24"><div align="center"><a href=teacher_del.asp?admin_ID=<%=rs("admin_ID")%>><font color="#ff6633">删除</font></a></div></td>
                                            </tr>
                                            <%rs.movenext
next
else
...
%>
                                      ...
                                      <tr>
                                        <td height="25" colspan="6"><div align="center"><a href="teacher_add.asp" class="style6">添加新教务员</a></div></td>
                                      </tr>
                                    </table>
                                </div></td>
                              </tr>
