...
%>
                              <table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                <tr>
                                  ...
                                  <td width="321" height="24"><div align="center" class="style10">标题</div></td>
...
%>
                                <tr>
                                  ...
                                  <td width="50" height="24"><div align="center" class="style3"><a href=job_mod.asp?job_ID=<%=rs("job_ID")%>><font color="#ff6633">修改</font></a></div></td>
                                  <td width="50" height="24"><div align="center" class="style3"><a href=job_del.asp?job_ID=<%=rs("job_ID")%>><font color="#ff6633">删除</font></a></div></td>
                                </tr>
                                <%rs.movenext
...
%>
&nbsp;页次：</span><span class="style3"><%=NoncePage%></span><span class="style2">/<font color="#0033CC"><%=NumPage%></font> 共<font color="#0033CC" class="style3"><%=NumRecord%></font>条记录</span>&nbsp; </div></td>
                                </tr>
                            </table></td>
                        </tr>
                      </table>
