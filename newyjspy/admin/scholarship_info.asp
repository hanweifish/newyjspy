...
scholarship_academy=trim(request("academy"))
session("scholarship_academy")=scholarship_academy
%>
                      ...
                      <tr>
                        <td height="54" background="adminimages/titlebk1.gif"><div align="center">
                            <table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td><div align="center"><a href="scholarship_infoadd.asp"><img src="adminimages/trainadd.gif" width="170" height="24" border="0"></a><a href="scholarship_infoadd.asp"></a></div></td>
                              </tr>
                            </table>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="86" background="adminimages/titlebk2.gif"><div align="center" class="style10">奖学金管理</div></td>
                      </tr>
                      <tr>
                            ...
                            <table width="90%"  cellspacing="0" cellpadding="0">
                              <tr>
                                <td><div align="center">
                                    <table width="100%"  cellspacing="0" cellpadding="0">
                                      ...
                                      <tr>
                                        <td><form action="scholarship_infoadd.asp" method="post" name="form" onSubmit="return checkform(form)">
                                        </form></td>
                                      </tr>
                                    </table>
                                </div></td>
                              ...
                              <tr>
                                <td><div align="center">
								 ...
								 sqlS="select user_info.user_name,user_info.user_number,scholarship_info.scholarship_prize,scholarship_info.scholarship_info,scholarship_info.scholarship_sorts,scholarship_info.scholarship_id from scholarship_info inner join user_info on scholarship_info.user_ID=user_info.user_ID where scholarship_academy='"&scholarship_academy&"' order by scholarship_info.scholarship_id desc"
	...
	NoncePage=0
								 ...
								 %>
                                          <tr class="style10">
                                            ...
                                            <td><div align="center">获奖名称</div></td>
                                            <td><div align="center">获奖奖励</div></td>
...
%>
                                          <tr class="style10">
                                            ...
                                            <td><div align="center"><%=rsS("scholarship_sorts")%></div></td>
                                            <td><div align="center"><%=rsS("scholarship_prize")%></div></td>
                                            <td><div align="center"><%=rsS("scholarship_info")%></div></td>
                                           
                                            <td class="style3"><div align="center"><a href=scholarship_infomod.asp?scholarship_ID=<%=rsS("scholarship_ID")%> class=style3 >修改</a></div></td>
                                            <td class="style3"><div align="center"><a href=scholarship_infodel.asp?scholarship_ID=<%=rsS("scholarship_ID")%> class=style3 >删除</a></div></td>
                                          </tr>
...
set rsS=nothing
                                ...
                                <form name="form1" method="post" action="scholarship_info.asp">
                                  <table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td valign="middle"><div align="right">
                                        <div align="right"> <span class="style2">
                                          <%
if NoncePage>1 then
	response.write "|<a href=scholarship_info.asp?page=1>首 页</a>| |<a href=scholarship_info.asp?page="&NoncePage-1&">上一页</a>|&nbsp"
else
	response.write "|首 页| |上一页|&nbsp"
end if
if Cint(Trim(NoncePage))<Cint(Trim(NumPage)) then
	response.write "|<a href=scholarship_info.asp?page="&NoncePage+1&">下一页</a>| |<a href=scholarship_info.asp?page="&NumPage&">尾 页</a>|"
else
