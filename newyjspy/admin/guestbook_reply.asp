...
<%
dim user_ID,guestbook_ID
guestbook_ID=trim(request("guestbook_ID"))
set rs=server.createobject("adodb.recordset")
sql="select user_info.user_mail from user_info inner join guestbook on user_info.user_ID=guestbook.user_ID where guestbook.guestbook_ID="&guestbook_ID
rs.open sql,conn,1,1
address=rs("user_mail")
%>
<%
rs.close
set rs=nothing
...
<script language="javascript">
	function checkform(form)
	{
		...
		else if (document.form.mail_from.value=="")
		{
			alert("请输入您的邮箱地址！");
		}
	    else
                      ...
                      <tr>
                        <td background="../user/userimages/titlebk.gif"><div align="center">
                            <table width="90%"  border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td><form name="form" method="post" action="mail_send.asp" >
                                    <div align="center">
                                      <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                        <tr>
                                          <td height="24"><div align="right"><span class="style10">收件人：&nbsp;&nbsp;</span></div></td>
                                          <td class="style10">&nbsp;&nbsp;&nbsp;
                                              <input name="address" type="text" class="style3" id="address" size="50" value="<%=address%>"></td>
                                        </tr>
                                        <tr>
                                          <td height="24"><div align="right" class="style10">标 题：&nbsp;&nbsp;</div></td>
                                          <td class="style10">&nbsp;&nbsp;&nbsp;
                                              <input name="subject" type="text" class="style3" id="subject" size="50"></td>
                                        </tr>
                                        <tr>
                                          <td ><div align="right" class="style10">正 文：&nbsp;&nbsp;</div></td>
                                          <td class="style10">&nbsp;&nbsp;&nbsp;
                                              <textarea name="content" cols="50" rows="15" class="style3" id="content"></textarea></td>
                                        </tr>
                                        <tr>
                                          <td height="24"><div align="right"><span class="style10">发件人：&nbsp;&nbsp;</span></div></td>
                                          <td class="style10">&nbsp;&nbsp;&nbsp;
                                              <input name="mail_from" type="text" class="style3" id="mail_from" size="50"></td>
                                        </tr>
                                        <tr>
                                          <td height="35" colspan="2"><div align="center"><img src="../user/userimages/send1.gif" width="51" height="23" align="absmiddle" style="cursor:hand" onmousedown="checkform(form)"> </div></td>
                                        </tr>
                                      </table>
                                    </div>
                                </form></td>
