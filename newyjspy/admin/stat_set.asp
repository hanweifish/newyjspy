                              ...
                              <tr>
                                <td><div align="center">
                                    <table width="100%"  cellspacing="0" cellpadding="0">
                                      ...
                                      <tr>
                                        <td><form action="stat_search.asp" method="post" name="form">
                                            <div align="center">
                                        ...
                                        <td class="style10">&nbsp;&nbsp;&nbsp;
										 ...
										 <option value="MG07" selected="selected">研一</option>
										 <option value="MG06">研二</option>
										 <option  value="MG05">研三</option>
										 <option  value="DG07">博一</option>
										 <option  value="DG06">博二</option>
										 <option  value="DG05">博三</option>
										 </select>                                                                             </td>
                                      </tr>
										 <tr>
                                        <td height="24"><div align="right" class="style10">所在院系：&nbsp;&nbsp;</div></td>
                                        <td class="style10">&nbsp;&nbsp;&nbsp;
                                            <input name="user_yx" type="text" class="style3" ></td>
                                      </tr>	
									   <tr>
                                        <td height="24"><div align="right" class="style10">性别：&nbsp;&nbsp;</div></td>
                                        <td class="style10">&nbsp;&nbsp;&nbsp;
                                            <select>
										 <option name="user_sex" value="boy" selected="selected">男</option>
										 <option name="user_sex" value="girl">女</option>
										 </select></td>
                                      </tr>	     
                                                <tr>
