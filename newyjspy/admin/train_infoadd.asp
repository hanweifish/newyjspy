                                ...
                                <td><div align="center">
									...
									%>                                        </td>
									  ...
									  <tr>
                                        ...
                                        <td class="style10">&nbsp;&nbsp;&nbsp;
                                            <input name="train_academy" type="text" class="style3" ></td>
                                      </tr>	     
                                                <tr>
...
&nbsp;&nbsp;&nbsp;</div></td>
                              ...
                              <tr>
                                <td><div align="center">
								 ...
								 sqlS="select top 6 user_info.user_name,user_info.user_number,user_info.user_yx,train_info.train_academy,train_info.train_info,train_info.train_ID,train_info.train_to from train_info inner join user_info on train_info.user_ID=user_info.user_ID order by train_info.train_academy"
