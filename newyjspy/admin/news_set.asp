...
%>
                                    <table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                      <tr>
                                        <td width="77" height="24"><div align="center" class="style10">发表日期</div></td>
                                        <td width="288" height="24"><div align="center" class="style10">出国消息标题</div></td>
                                        <td width="30" height="24"><div align="center" class="style10">修改</div></td>
                                        <td width="33" height="24"><div align="center" class="style10">删除</div></td>
                                      </tr>
                                      <%if Not(rs.bof and rs.eof) then
...
%>
                                      <tr>
                                        <td width="77" height="24"><div align="left" class="style10">&nbsp;&nbsp;<%=rs("news_time")%></div></td>
                                        <td height="24"><div align="left" class="style10">&nbsp;&nbsp;<%=rs("news_title")%></div></td>
                                        <td width="30" height="24"><div align="center"><a href=news_mod.asp?news_ID=<%=rs("news_ID")%>><font color="#ff6633">修改</font></a></div></td>
                                        <td width="33" height="24"><div align="center"><a href=news_del.asp?news_ID=<%=rs("news_ID")%>><font color="#ff6633">删除</font></a></div></td>
                                      </tr>
                                      <%rs.movenext
