...
response.write"<script>alert('设置选课状态成功！')</script>"
end if
%>
                            ...
                            <table width="90%"  border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <form name="form1" method="post" action="">
                                  <td height="30" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;选课开始时间设定&nbsp;：&nbsp;&nbsp;
...
&nbsp;<span class="style3">必须按格式输入：2005-05-18，按回车确认</span></td>
                              ...
                              <tr>
                                <form name="form1" method="post" action="">
                                  <td height="30" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;选课截止时间设定&nbsp;：&nbsp;&nbsp;
...
&nbsp;<span class="style3">必须按格式输入：2005-05-18，按回车确认</span></td>
                              ...
                              <tr>
                                <td height="30">
                                  <div align="center">
                                    <input name="select" type="button" class="style8" id="select" onclick ="window.location.href='course_set.asp?select=yes'" value="开始选课按钮">
                                  </div></td>
                                <td><div align="center">
                                    <input name="select" type="button" class="style3" id="select" onclick ="window.location.href='course_set.asp?select=no'" value="强行中止选课">
                                  </div></td>
                              </tr>
                              <tr>
                                <td height="25" colspan="2">                                  <div align="center"><span class="style2">选 课 课 程 列 表</span> </div></td>
                              </tr>
                              <tr>
...
%>
                                    <table width="100%" height="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                      <tr>
                                        ...
                                        <td width="80" height="24"><div align="center" class="style10">课程编号</div></td>
                                        <td width="80" height="24"><div align="center" class="style10">主讲老师</div></td>
                                        <td width="50" height="24"><div align="center" class="style10">学分</div></td>
                                        <td width="80" height="24"><div align="center" class="style10">是否参与选课</div></td>
...
%>
                              ...
                              <%
								  ...
								  %>
                                        ...
                                        <td width="50" height="24"><div align="center"><a href=course_mod.asp?course_ID=<%=rs("course_ID")%>><font color="#ff6633">修改</font></a></div></td>
                                        <td width="50" height="24"><div align="center"><a href=course_del.asp?course_ID=<%=rs("course_ID")%>><font color="#ff6633">删除</font></a></div></td>
                                      </tr>
                                      <%rs.movenext
...
%>
                                      <tr>
                                        <td height="24" colspan="8"><div align="right"> <span class="style10">
                                            ...
                                            <%
if NoncePage>1 then
	response.write "|<a href=course_set.asp?page=1>首 页</a>| |<a href=course_set.asp?page="&NoncePage-1&">上一页</a>|&nbsp"
else
	response.write "|首 页| |上一页|&nbsp"
end if
if Cint(Trim(NoncePage))<Cint(Trim(NumPage)) then
	response.write "|<a href=course_set.asp?page="&NoncePage+1&">下一页</a>| |<a href=course_set.asp?page="&NumPage&">尾 页</a>|"
else
