                  ...
                  <tr>
                    <td background="../user/userimages/titlebk.gif"><div align="center">
                      <table width="90%"  border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td><form name="form" method="post" action="job_mod1.asp">
                              <div align="center">
                                <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                  <tr>
                                    <td width="100" height="24"><div align="right" class="style10">
                                        <div align="center" class="style2">信息标题：</div>
                                    </div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <input name="job_title" type="text" class="style2" value="<%=rs("job_title")%>"></td>
                                  </tr>
                                  <tr>
                                    <td width="100" ><div align="right" class="style10">
                                        <div align="center" class="style2">信息内容：</div>
                                    </div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <textarea name="job_content" cols="50" rows="15" class="style2" ><%=rs("job_content")%></textarea></td>
                                  </tr>
                                  <tr>
                                    <td width="100" ><div align="right" class="style2">
                                        <div align="center" class="style2">信息备注：</div>
                                    </div></td>
                                    <td class="style2">&nbsp;&nbsp;&nbsp;
                                        <textarea name="job_info" cols="50" rows="10" class="style2"><%=rs("job_info")%></textarea>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td ><div align="center" class="style2">发表人：</div></td>
                                    <td height="25" class="style2">&nbsp;&nbsp;&nbsp; 
										<input name="job_author" type="text" class="style2" value="<%=rs("job_author")%>">
									</td>
                                  </tr>
                                  <tr>
                                    <td height="35" colspan="2"><div align="center">
                                      <img src="../user/userimages/editSub.gif" width="70" height="25" align="absmiddle" style="cursor:hand" onmousedown="javascript:submit();"> </div></td>
                                  </tr>
                                </table>
                              </div>
                          </form></td>
