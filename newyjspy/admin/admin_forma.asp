...
&nbsp;&nbsp;                            <img src="../user/userimages/search.gif" width="46" height="23" align="absbottom" style="cursor:hand" onMouseDown="javascript:checkform(form3)">
						<input type="hidden" name="noid" value="<%=studentid%>">
                          </form>
                          <br>
                                       <%
if not rs1.eof then
...
%>
                          <table width="90%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                            ...
                            <%
	'if request("noid")<>empty then
	'studentid=cint(request("noid"))
	'end if
	if Not(rs.bof and rs.eof) then
                                    ...
                                    <tr>
                                      <td valign="middle"><div align="right">
                                        <div align="right"> <span class="style2">
                                          <%
if NoncePage>1 then
	response.write "|<a href=admin_form.asp?page=1>首 页</a>| |<a href=admin_form.asp?page="&NoncePage-1&">上一页</a>|&nbsp"
else
	response.write "|首 页| |上一页|&nbsp"
end if
if Cint(Trim(NoncePage))<Cint(Trim(NumPage)) then
	response.write "|<a href=admin_form.asp?page="&NoncePage+1&">下一页</a>| |<a href=admin_form.asp?page="&NumPage&">尾 页</a>|"
else
