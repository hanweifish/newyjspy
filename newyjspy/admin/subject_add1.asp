...
<script language="javascript">
	function checkform(form)
	{
		...
		else if (document.form.tutor.value=="")
		{
			alert("请输入授课老师！");
		}
                    ...
                    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td background="../user/userimages/titlebk.gif"><div align="center">
                            <form name="form" method="post" action="subject_add2.asp">
                              <div align="center">
                                <table width="90%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                  ...
                                  <tr>
                                    ...
                                    <td class="style10"><div align="left">&nbsp;&nbsp;&nbsp;
                                        <input name="teachway" type="text" class="style3" id="teachway" >
                                    </div></td>
                                  </tr>
                                  <tr>
                                    <td height="35" colspan="2"><div align="center">
                                       <input type="hidden" name="course_academy" value="<%=course_academy%>" > 
