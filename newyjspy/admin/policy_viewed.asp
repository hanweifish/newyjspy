                                ...
                                <td><form name="form" method="post" action="policyname_result.asp" onsubmit="return checkform()">
                                    <div align="center"> <br>
                                        ...
                                        <table width="95%" height="50" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin" >
                                          ...
                                          <tr valign="middle">
                                            <td colspan="3"><div align="center" class="style3">查看单个学生浏览过的政策</div></td>
                                          </tr>
                                        </table>
                                    </div>
                                </form></td>
                                ...
                                <td><div align="center">
                                    <form name="form1" method="post" action="policytitle_result.asp" onsubmit="return checkform1()">
                                      <div align="center">
                                        <table width="95%" height="50" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin" >
                                          <tr valign="middle">
                                            <td width="180" height="35"><div align="right" class="style3">按政策查询：</div></td>
                                            <td><div align="center">
                                          ...
                                          <tr valign="middle">
                                            <td colspan="3"><div align="center" class="style3">查看某条政策的浏览情况</div></td>
                                          </tr>
                                        </table>
                                      </div>
                                    </form>
