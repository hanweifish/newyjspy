                    ...
                    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td background="../user/userimages/titlebk.gif"><div align="center">
                            <form name="form" method="post" action="policy_mod1.asp">
                              <div align="center">
                                <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                  <tr>
                                    <td width="100" height="24"><div align="right" class="style10">
                                        <div align="center">政策标题：</div>
                                    </div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <input type="text" name="policy_title" value="<%=rs("policy_title")%>"></td>
                                  </tr>
                                  <tr>
                                    <td width="100" ><div align="right" class="style10">
                                        <div align="center">政策内容：</div>
                                    </div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <textarea name="policy_content" cols="50" rows="15" ><%=rs("policy_content")%></textarea></td>
                                  </tr>
                                  <tr>
                                    <td width="100" ><div align="right" class="style10">
                                        <div align="center">政策备注：</div>
                                    </div></td>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <textarea name="policy_info" cols="50" rows="10"><%=rs("policy_info")%></textarea>
                                    </td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <input type="text" name="policy_author" value="<%=rs("policy_author")%>"></td>
                                  </tr>
                                  <tr>
