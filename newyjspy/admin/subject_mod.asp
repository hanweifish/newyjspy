                                ...
                                <td><form name="form" method="post" action="subject_mod1.asp?page=<%=page%>">
                                    <div align="center">
                                      <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                        ...
                                        <tr>
                                          <td height="24"><div align="right"><span class="style10">学分数：&nbsp;&nbsp;</span></div></td>
                                          <td class="style10">&nbsp;&nbsp;&nbsp;
                                              <input name="term" type="text" class="style3" id="term" value="<%=rs("term")%>"></td>
                                        </tr>
                                        <tr>
                                          <td height="24"><div align="right"><span class="style10">所属院系：&nbsp;&nbsp;</span></div></td>
                                          <td class="style10">&nbsp;&nbsp;&nbsp;
                                            <input name="academy" type="text" class="style3" id="academy" value="<%=rs("course_yx")%>"></td>
                                        </tr>
                                        <tr>
