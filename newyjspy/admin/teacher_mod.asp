                      ...
                      <tr>
                        <td background="../user/userimages/titlebk.gif"><div align="center">
                            <table width="90%"  border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td><form name="form" method="post" action="teacher_mod1.asp">
                                    <div align="center">
                                      <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                        ...
                                        <tr>
                                          ...
                                          <td class="style10">&nbsp;&nbsp;&nbsp;
                                            <input type="text" name="admin_yx" class="style3" size="24" value="<%=rs("admin_yx")%>">   </td>
                                        </tr>
                                        <tr>
                                          <td height="24"><div align="right" class="style10">所属院系(英)：&nbsp;&nbsp;</div></td>
                                          <td class="style10">&nbsp;&nbsp;&nbsp;
                                              <input type="text" name="admin_academy" class="style3" size="24" value="<%=rs("admin_academy")%>"></td>
                                        </tr>
                                        <tr>
                                          <td height="24"><div align="right" class="style10">备注：&nbsp;&nbsp;</div></td>
                                          <td class="style10">&nbsp;&nbsp;&nbsp;
                                              <textarea name="admin_info" cols="36" rows="3" class="style3">无</textarea>                                          </td>
                                        </tr>
                                        <tr>
