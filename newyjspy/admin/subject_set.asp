...
sql="select * from subject order by course_academy"
...
%>
                                    <table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                      <tr>
                                        ...
                                        <td width="118"><div align="center"><span class="style10">学期</span></div></td>
                                        <td width="118" height="24"><div align="center" class="style10">主讲老师</div></td>
                                        <td width="55" height="24"><div align="center" class="style10">学分</div></td>
										<td width="55" height="24"><div align="center" class="style10">院系</div></td>
...
%>
                                      <tr>
										...
										<td height="24"><div align="center" class="style10"><%=rs("course_yx")%></div></td>
