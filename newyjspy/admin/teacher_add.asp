                      ...
                      <tr>
                        <td background="../user/userimages/titlebk.gif"><div align="center">
                            <table width="90%"  border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td valign="top"><form name="form" method="post" action="teacher_add1.asp" onSubmit="return checkform()">
                                    <div align="center">
                                      <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                                        <tr>
                                          <td height="24"><div align="right" class="style10">教务员帐号：&nbsp;&nbsp;</div></td>
                                          <td class="style10">&nbsp;&nbsp;&nbsp;
                                              <input name="admin_account" type="text" class="style3" size="24"></td>
                                        </tr>
                                        <tr>
                                          <td height="24"><div align="right" class="style10">教务员密码：&nbsp;&nbsp;</div></td>
                                          <td class="style10">&nbsp;&nbsp;&nbsp;
                                            <input name="admin_pwd" type="text" class="style3" size="24"></td>
                                        </tr>
                                        <tr>
                                          <td height="24"><div align="right" class="style10">所属院系：&nbsp;&nbsp;</div></td>
                                          <td class="style10">&nbsp;&nbsp;&nbsp;
                                              <input name="admin_yx" type="text" class="style3" size="24"></td>
                                        </tr>
                                        <tr>
                                          <td height="24"><div align="right" class="style10">所属院系(英)：&nbsp;&nbsp;</div></td>
                                          <td class="style10">&nbsp;&nbsp;&nbsp;
                                          <input name="admin_academy" type="text" class="style3" size="24"></td>
                                        </tr>
                                        <tr>
