...
<script language="javascript">
	...
	{
		if (document.form1.user_number.value=="")
		{
			alert("请输入学生学号！");
		}
		else
                              ...
                              <tr>
                                <td colspan="6" valign="top"><div align="center">
                                    <table width="100%" cellpadding="0" cellspacing="0" >
                                      <tr>
                                        <td><form name="form" method="post" action="name_search.asp">
                                            <div align="center"> <br>
                                                <br>
                                                <table width="95%" height="50" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin" >
                                                  <tr valign="middle">
                                                    <td width="180"><div align="right" class="style12">按姓名查询：</div></td>
                                                    <td><div align="center">
                                                        <input name="user_name" type="text" class="style3" id="user_name" size="32">
                                                    </div></td>
                                                    <td width="100"><div align="center"><img src="../user/userimages/search.gif" width="46" height="23" style="cursor:hand" onMouseDown="javascript:checkform(form)"></div></td>
                                                  </tr>
                                                </table>
                                            </div>
                                        </form></td>
                                      ...
                                      <tr>
                                        <td><div align="center">
                                            <form name="form1" method="post" action="number_search.asp">
                                              <div align="center">
                                                <table width="95%" height="50" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000"  class="thin">
                                                  <tr valign="middle">
                                                    <td width="180"><div align="right" class="style12">按学号查询：</div></td>
                                                    <td><div align="center">
                                                        <input name="user_number" type="text" class="style3" id="user_number" size="32">
                                                    </div></td>
                                                    <td width="100"><div align="center"><img src="../user/userimages/search.gif" width="46" height="23" style="cursor:hand" onMouseDown="javascript:checkform1(form1);"></div></td>
                                                  </tr>
                                                </table>
                                              </div>
                                            </form>
