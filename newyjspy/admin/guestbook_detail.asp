...
sql="select user_info.user_name,user_info.user_mail,guestbook.admin_read,guestbook.content,guestbook.guestbook_ID,guestbook.user_time,guestbook.admin_time,guestbook.title from guestbook inner join user_info on guestbook.user_ID=user_info.user_ID where guestbook.guestbook_ID="&guestbook_ID
                                    ...
                                    <table width="80%"  border="0" cellpadding="0" cellspacing="0" class="thin">
                                      <tr>
                                        <td><table width="100%"  border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                              <td height="25" bgcolor="#CFDBEF"><div align="center" class="style3"><%=rs("title")%></div></td>
                                            </tr>
                                            <tr>
                                              <td><div align="center">
                                                  <table width="80%"  border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                      <td width="39%" height="20" class="style10">发表者：<%=rs("user_name")%></td>
                                                      <td width="17%" class="style9"><div align="right"></div></td>
                                                      <td width="44%" class="style9"><div align="right" class="style10">发布时间：<%=rs("user_time")%>&nbsp;&nbsp;</div></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                      <td colspan="3"><br>
                                                          <span class="style2"><%=HTMLEncode(rs("content"))%></span><br>
&nbsp;</td>
                                                    </tr>
                                                  </table>
                                              </div></td>
