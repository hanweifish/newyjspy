                ...
                <table width="603"  border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td colspan="3"><div align="center">
                        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="54" background="userimages/titlebk1.gif">&nbsp;</td>
                          </tr>
                          <tr>
                            <td height="53" background="userimages/titlebk2.gif"><div align="center"><a href="adminapply_nation.asp" target="_blank">公派出国申报</a></div></td>
                          </tr>
                          <tr>
                            <td background="userimages/titlebk.gif"><div align="center">
                              <p><a href="adminapply_nation.asp" target="_blank"></a></p>
                              <p>毕业信息提交</p>
                            </div></td>
                          </tr>
                          <tr>
