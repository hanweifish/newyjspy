...
%>
                            <table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="thin">
                              <tr align="center">
                                ...
                                <td width="352" height="24"><div align="center" class="style10">通 &nbsp;&nbsp;&nbsp;知 &nbsp;&nbsp;&nbsp;标 &nbsp;&nbsp;&nbsp;题 </div></td>
                                <td width="35"><div align="center">点击</div></td>
                              </tr>
...
%>
                              <tr>
                                ...
                                <td height="25"><div align="left"></div>
                                    <div align="left">&nbsp;&nbsp;&nbsp;&nbsp;<a href=notice_detail.asp?notice_ID=<%=rsn("notice_ID")%>  target="_blank" class="style3"><%=rsn("notice_title")%></a></div></td>
                                <td><div align="center"><%=rsn("notice_click")%></div></td>
                              </tr>
                              <%rsn.movenext
...
%>
                              <tr>
                                <td height="24" colspan="9" align="center" valign="middle"><div align="right"><span class="style2">
                                    ...
                                    <%
if NoncePage>1 then
	response.write "|<a href=noticelist.asp?page=1>首 页</a>| |<a href=noticelist.asp?page="&NoncePage-1&">上一页</a>|&nbsp"
else
	response.write "|首 页| |上一页|&nbsp"
end if
if Cint(Trim(NoncePage))<Cint(Trim(NumPage)) then
	response.write "|<a href=noticelist.asp?page="&NoncePage+1&">下一页</a>| |<a href=noticelist.asp?page="&NumPage&">尾 页</a>|"
else
