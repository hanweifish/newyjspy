...
<div align="center">
  ...
  <table width="840" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td height="40" bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;&nbsp;您的当前位置：&gt;&gt; <a href="Index.asp">上传文件</a> &gt;&gt; 保存图片
&nbsp;&nbsp; <a href="../admin/admin_logout.asp">［注销］</a></td>
          ...
          <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="150"><table width="98%" border="0" cellspacing="0" cellpadding="3" bgcolor="#FFFFFF">
                  ...
                  <tr class="text">
                    <td><div align="center">本页将在10秒后返回 如果您的浏览器没有反应，请点击<a href="Index.asp">此处返回</a></div></td>
                  </tr>
              </table></td>
            </tr>
          </table>
