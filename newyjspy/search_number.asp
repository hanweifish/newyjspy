                ...
                <td><table width="100%" height="180" border="0" cellpadding="0" cellspacing="0">
                    <tr>
					  ...
					  <form name="form1" method="post" action="results.asp">
					   <span class="style2">输入新生姓名</span>:
					     <input name="user_name" type="text" size="20" id="user_name"  class="style3" ><div align="center"><br><img src="user/userimages/search.gif" width="46" height="23" style="cursor:hand" onMouseDown="javascript:checkform1(form1)"></div>
					  </form>
